...
Required companion decisions: `PROJECT_BOUNDARY.md`, ADR-0001 realtime authority ownership, the World match-evidence commitment boundary, and the settlement transaction-split design.
...
1. Integrate the plan/boundary and settlement-runtime branches on one review branch.
