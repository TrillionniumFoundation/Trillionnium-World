...
- Release-review evidence assembly is split into `trnm-rts-evidence`, including the campaign UI continuity handoff review, session-state continuity review, continuous player-flow review, and release-review packet assembly review.
