...
- Release-review evidence assembly is split into `trnm-rts-evidence`, including the campaign UI continuity handoff review and session-state continuity review.
