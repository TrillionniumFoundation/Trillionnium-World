...
- `trnm-rts-bevy-runtime` exists and owns deterministic camera, minimap, projection, path-preview, tile-line, hit-test, runtime layout calculations, the First Contact player-screen runtime application contract, the First Contact offline-adapter runtime application contract, and the First Contact offline-adapter player-screen consumption review contract.
