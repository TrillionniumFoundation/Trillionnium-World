...
- Release-review evidence assembly is split into `trnm-rts-evidence`, including the campaign UI continuity handoff review, session-state continuity review, and release-review packet assembly review.
