...
Classic RTS production-art note: `scripts/check_trillionnium_world_bevy_classic_rts_production_art_replication.sh`, `scripts/check_trillionnium_world_bevy_classic_rts_production_asset_atlas.sh`, `scripts/check_trillionnium_world_bevy_classic_rts_production_ui_skin.sh`, and `scripts/check_trillionnium_world_bevy_classic_rts_production_interaction_polish.sh` bind original Bevy production art, texture-atlas slices, eight production UI skin surfaces, and skinned drag/right-click/attack/build/queue/scroll feedback into classic playtest readiness plus release-review CI while keeping no-copy, Android S5, GPU-upload, production-ready UI, and public-launch blockers explicit.
