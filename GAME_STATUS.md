...
- sixteen connected rooms across Mirror City, Signal Road, Glass Basin and the Ashen Fringe, with story locks and authoritative route planning;
- three exclusive clean-room sects, three mentors and ten relationship NPC definitions;
- fifteen authored regional quests across courier, investigation, supply, hunt, escort and training-trial archetypes; every quest has a deadline, failure/retry state, typed step verbs and Direct/Diplomatic/Resourceful resolutions with trust or resource gates;
- seven RPG encounter definitions, encounter-specific original combat logs, telegraphed enemy moves, bleed/exposure/guard states and four sect-bound cooldown techniques;
...
- world time, stamina, rations, water, injuries, trust, rank, journal and route planning; all ten NPCs move between work/civic/rest rooms and expose five relationship stages plus three dialogue intents;
- deterministic daily market demand, buy/sell pricing, a browsable shop/craft surface and owned-equipment selector;
...
- authoritative worker logistics, resources, supply, power, construction, repair, production, research and upgrades for the player, plus a deterministic opposing resource/build/research/production loop in skirmish;
...
- `trnm_campaign_save_v1`, schema revision 4;
- `trnm_battle_seed_v8`;
- `trnm_battle_result_v2`;
- `trnm_settlement_receipt_v1`;
- `trnm_rts_sim_v11` / `trnm_rts_sim_checkpoint_v11`;
...
- five-crate unit/integration/E2E suite: 91/91 passing;
...
- current X230 validation matrix after the v2 depth pass: RPG 3.10 s / 284 MiB, campaign 10.10 s / 514 MiB, RTS 38.81 s / 459 MiB, closed loop 12.33 s / 71 MiB, incremental release build 55.35 s / 742 MiB;
