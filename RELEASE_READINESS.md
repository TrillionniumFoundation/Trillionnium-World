...
- **Current game depth evidence**: `GAME_STATUS.md` enumerates the revision-8 branch-consequence/chapter/post-ending/autonomous-social/regional-logistics state and the side-tagged shared job/construction/structure, meaningful-seed, normal-growth terminal, economy-matrix and interactive chunked-replay authority. The automated real-map/faction/spawn/seed matrix is regression evidence, not a public-launch or esports-balance claim.
