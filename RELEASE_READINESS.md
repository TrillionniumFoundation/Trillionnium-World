...
- **Current game depth evidence**: `GAME_STATUS.md` enumerates the revision-5 authored RPG condition/social/economy state and the v12 symmetric RTS worker/building/ability/replay authority. The automated four-map/faction-swap/multi-seed matrix is regression evidence, not a public-launch or esports-balance claim.
