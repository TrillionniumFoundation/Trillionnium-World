...
SUMMARY_FILE="$ACCEPTANCE_DIR/release-review-packet-integrity-tech-tree-semantic-fixture.json"
if [[ -v TRILLIONNIUM_WORLD_RELEASE_REVIEW_PACKET_INTEGRITY_TECH_TREE_SEMANTIC_FIXTURE_SUMMARY && -n "$TRILLIONNIUM_WORLD_RELEASE_REVIEW_PACKET_INTEGRITY_TECH_TREE_SEMANTIC_FIXTURE_SUMMARY" ]]; then
  SUMMARY_FILE="$TRILLIONNIUM_WORLD_RELEASE_REVIEW_PACKET_INTEGRITY_TECH_TREE_SEMANTIC_FIXTURE_SUMMARY"
fi
...
jq -n \
  ...
  '{
    ...
    source_of_truth: "trillionnium_world_release_review_packet_integrity_tech_tree_semantic_fixture",
    green: true,
    ...
    reviewer_next_action: "inspect_release_review_packet_integrity_tech_tree_semantic_fixture_before_collecting_real_external_public_launch_evidence"
  }' >"$SUMMARY_FILE"
...
printf 'TRILLIONNIUM_WORLD_RELEASE_REVIEW_PACKET_INTEGRITY_TECH_TREE_SEMANTIC_FIXTURE_GREEN %s\n' "$SUMMARY_FILE"
