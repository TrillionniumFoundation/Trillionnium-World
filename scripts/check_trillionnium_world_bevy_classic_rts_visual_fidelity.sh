...
jq -e '
  ...
  and (.selected_unit_ids | index("arena_guard_left") != null)
  and (.selected_unit_ids | index("arena_creep_attack") != null)
  and (.ability_command_ids | length) >= 6
  and (.command_queue | index("attack:arena_creep_attack") != null)
