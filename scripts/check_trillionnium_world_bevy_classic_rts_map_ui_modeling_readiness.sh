...
"$ROOT/scripts/run_trillionnium_world_bevy_artifact_command.sh" classic-rts-map-ui-modeling-readiness "$PREVIEW_DIR" >"$SUMMARY"
...
jq -e '
  ...
  and .visual_fidelity_pixels.basin_tactical_viewport > 2800
