...
required_script_lines=(
  ...
  'first_contact_production_art_pack_id == "first_contact_production_art_pack_v5"'
  'player_first_map_composition_gate == true'
  'player_first_production_art_pack_v2_gate == true'
  'player_first_production_art_pack_v3_gate == true'
  'player_first_production_art_pack_v4_gate == true'
  'player_first_production_art_pack_v5_gate == true'
  'player_first_production_art_pack_gate == true'
...
required_source_lines=(
  ...
  'first_contact_production_art_pack_v5_pixel_counts'
  ...
  'player_first_production_art_pack_v5_gate'
  'player_first_production_art_pack_gate'
...
required_readiness_lines=(
  ...
  'rts_full_game_visual_ui_replication_first_contact_production_terrain_material_pixel_count > 20000'
  'rts_full_game_visual_ui_replication_first_contact_production_unit_sprite_skin_pixel_count > 120'
  'rts_full_game_visual_ui_replication_first_contact_production_structure_sprite_skin_pixel_count > 160'
  'rts_full_game_visual_ui_replication_first_contact_production_hud_skin_pixel_count > 8000'
  'rts_full_game_visual_ui_replication_first_contact_production_v3_gate == true'
  'rts_full_game_visual_ui_replication_first_contact_production_terrain_cluster_pixel_count > 1000'
  'rts_full_game_visual_ui_replication_first_contact_production_transition_corner_pixel_count > 300'
  'rts_full_game_visual_ui_replication_first_contact_production_unit_role_block_pixel_count > 80'
  'rts_full_game_visual_ui_replication_first_contact_production_structure_roof_depth_pixel_count > 100'
  'rts_full_game_visual_ui_replication_first_contact_production_action_priority_ribbon_pixel_count > 80'
  'rts_full_game_visual_ui_replication_first_contact_production_hud_command_plate_pixel_count > 8000'
  'rts_full_game_visual_ui_replication_first_contact_production_v4_gate == true'
  'rts_full_game_visual_ui_replication_first_contact_production_terrain_strata_pixel_count > 1000'
  'rts_full_game_visual_ui_replication_first_contact_production_edge_occlusion_pixel_count > 300'
  'rts_full_game_visual_ui_replication_first_contact_production_unit_readability_crest_pixel_count > 80'
  'rts_full_game_visual_ui_replication_first_contact_production_structure_volume_shadow_pixel_count > 100'
  'rts_full_game_visual_ui_replication_first_contact_production_action_intent_arrow_pixel_count > 80'
  'rts_full_game_visual_ui_replication_first_contact_production_hud_focus_strip_pixel_count > 600'
