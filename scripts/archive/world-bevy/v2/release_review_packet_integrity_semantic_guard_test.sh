...
add_cex_adapter_readiness_packet_fixtures semantic_invalid
...
jq -n '{
  ...
  execution_log: [
    {accepted: true, command_marker_hit: true},
    {accepted: true, command_marker_hit: true},
    {accepted: true, command_marker_hit: true},
    {accepted: true, command_marker_hit: true},
    {accepted: true, command_marker_hit: true},
  ...
  preview_paths: {
    action_preview: "/tmp/bot-planner-action-executor.ppm",
    action_log: "/tmp/bot-planner-action-executor.actions.json"
  },
  ...
  write_preview_gate: true,
  source_contract_gate: true,
  source_loop_gate: true,
  action_mapping_gate: true,
  executor_acceptance_gate: true,
  runtime_mutation_gate: true,
  terminal_source_alignment_gate: true,
  preview_gate: true,
  action_log_write_gate: true,
  action_log_readback_gate: true,
  action_log_gate: true,
  boundary_gate: true,
  action_label_count: 6,
  expected_command_marker_count: 6,
  input_source_count: 1,
  execution_log_count: 6,
  preview_path_count: 2,
  final_runtime_summary_field_count: 5,
  gate_count: 13,
...
jq -n '{
  ...
  replay_execution_log: [
    {accepted: true, action_label_parse_gate: true, command_marker_hit: true, command_delta_match: true},
    {accepted: true, action_label_parse_gate: true, command_marker_hit: true, command_delta_match: true},
    {accepted: true, action_label_parse_gate: true, command_marker_hit: true, command_delta_match: true},
    {accepted: true, action_label_parse_gate: true, command_marker_hit: true, command_delta_match: true},
    {accepted: true, action_label_parse_gate: true, command_marker_hit: true, command_delta_match: true},
  ...
  preview_paths: {
    replay_preview: "/tmp/bot-planner-executor-replay-determinism.ppm",
    replay_log: "/tmp/bot-planner-executor-replay-determinism.replay.json"
  },
  source_final_runtime_summary: {
    faction_id: "mirror_guard",
    objective_capture_percent: 100,
    tier_two_tech_ids: ["relay_foundry"],
    siege_breach_state: "counterplay_won:gate_bulwark",
  ...
  write_preview_gate: true,
  source_contract_gate: true,
  source_executor_gate: true,
  source_action_log_readback_gate: true,
  replay_mapping_gate: true,
  replay_acceptance_gate: true,
  preview_gate: true,
  replay_log_write_gate: true,
  replay_log_readback_gate: true,
  replay_log_gate: true,
  boundary_gate: true,
  replayed_action_label_count: 6,
  replay_input_source_count: 1,
  replay_execution_log_count: 6,
  preview_path_count: 2,
  source_final_runtime_summary_field_count: 5,
  replay_final_runtime_summary_field_count: 5,
  gate_count: 13,
  passed_gate_count: 13,
  failed_gate_count: 0,
...
jq -n '{
  ...
  variant_seed_values: ["2026052901", "2026052902", "2026052903", "2026052904"],
  variant_economy_values: ["balanced", "low_gold", "high_pressure", "delayed_tech"],
  variant_summaries: [
    {variant_id: "seed_2026052901_forest_relay", map_variant: "forest_relay", economy_variant: "balanced"},
    {variant_id: "seed_2026052902_ridge_watch", map_variant: "ridge_watch", economy_variant: "low_gold"},
    {variant_id: "seed_2026052903_marsh_gate", map_variant: "marsh_gate", economy_variant: "high_pressure"},
    {variant_id: "seed_2026052904_market_ruins", map_variant: "market_ruins", economy_variant: "delayed_tech"}
  ],
  preview_paths: {
    evaluation_preview: "/tmp/multi-match-bot-executor-evaluation.ppm",
    evaluation_log: "/tmp/multi-match-bot-executor-evaluation.matches.json"
  },
  ...
  write_preview_gate: true,
  source_replay_contract_gate: true,
  source_replay_gate: true,
  source_action_log_readback_gate: true,
  variant_count_gate: true,
  variant_diversity_gate: true,
  multi_match_acceptance_gate: true,
  multi_match_runtime_gate: true,
  preview_gate: true,
  evaluation_log_write_gate: true,
  evaluation_log_readback_gate: true,
  evaluation_log_gate: true,
  boundary_gate: true,
  variant_summary_count: 4,
  variant_seed_count: 4,
  variant_map_count: 4,
  variant_economy_count: 4,
  preview_path_count: 2,
  source_replay_summary_field_count: 4,
  gate_count: 14,
...
jq -n \
  ...
  '{
    ...
    write_preview_gate: true,
    source_multi_match_contract_gate: true,
    source_multi_match_gate: true,
    source_action_log_readback_gate: true,
    blocked_rejection_gate: true,
    blocked_non_pollution_gate: true,
    recovery_acceptance_gate: true,
    recovery_runtime_gate: true,
    input_source_gate: true,
    preview_gate: true,
    matrix_log_write_gate: true,
    matrix_log_readback_gate: true,
    matrix_log_gate: true,
    boundary_gate: true,
    source_replay_action_count: 6,
    blocked_injection_count: 6,
    blocked_rejection_count: 6,
    ...
    preview_paths: {
      matrix_preview: "/tmp/bot-executor-failure-recovery-matrix.ppm",
      matrix_log: "/tmp/bot-executor-failure-recovery-matrix.matrix.json"
    },
    ...
    blocked_input_source_count: 1,
    recovery_input_source_count: 1,
    matrix_log_count: 6,
    preview_path_count: 2,
    source_multi_match_summary_field_count: 4,
    final_recovery_safe_runtime_summary_field_count: 5,
    gate_count: 15,
...
jq -n '{
  ...
  rts_core_contract: "trnm_rts_core_frame_order_v1",
  rts_bot_decision_core_frame_order_gate: true,
  rts_bot_decision_core_headless_replay_gate: true,
  rts_bot_decision_core_frame_order_stream_sha256: "078391be14c25e04a912ae70bdd098e2e5e040844a585a710bbb21fce985ff6a",
  rts_bot_decision_core_headless_checkpoint_sha256: "dc37423ccb7644f48b58e467f904f574a4adf79836dc87a0ed0563d1c27f60c7",
  rts_bot_decision_core_frame_order_kind_labels: ["harvest", "recon", "capture", "research", "attack", "move"],
  rts_bot_decision_core_headless_applied_order_count: 6,
  rts_bot_decision_core_headless_actor_count: 3,
  rts_bot_decision_core_headless_final_frame: 1005,
  ...
  rts_bot_decision_core_headless_recon_ids: ["beacon_ring"],
  rts_bot_decision_core_headless_objective_ids: ["relay_beacon"],
  rts_bot_decision_core_headless_researched_rule_ids: ["signal_array"],
  rts_bot_decision_core_headless_combat_target_actor_ids: ["counter_push"],
  rts_bot_decision_core_headless_combat_target_tile_ids: ["8,4"],
...
jq -n '{
  ...
  final_objective_capture_percent: 90,
	  ...
	  rts_bot_adaptive_core_frame_order_stream_sha256: "9e3bc97d3a4f43ff948e9fc06f79f2d7f9d777974e8421ac68894c950e8e2b0d",
	  rts_bot_adaptive_core_headless_checkpoint_sha256: "e5b3bb9f2d2a66778d16e89f35a3cca74863ee2d30cc398c3c21cd842be47169",
	  rts_bot_adaptive_core_frame_order_kind_labels: ["harvest", "build", "train", "recon", "build", "research", "train", "attack", "move"],
	  rts_bot_adaptive_core_headless_applied_order_count: 9,
	  rts_bot_adaptive_core_headless_actor_count: 3,
	  rts_bot_adaptive_core_headless_final_frame: 1408,
	  rts_bot_adaptive_core_headless_harvest_actor_order_count: 3,
	  rts_bot_adaptive_core_headless_build_order_count: 2,
	  rts_bot_adaptive_core_headless_train_order_count: 2,
	  rts_bot_adaptive_core_headless_build_rule_ids: ["relay_refinery", "forge_natural_defense"],
	  rts_bot_adaptive_core_headless_train_rule_ids: ["trnm.worker", "trnm.horizon.skimmer"],
	  rts_bot_adaptive_core_headless_scout_order_count: 1,
	  rts_bot_adaptive_core_headless_recon_ids: ["enemy_fast_beacon"],
	  rts_bot_adaptive_core_headless_recon_tile_ids: ["6,5"],
	  rts_bot_adaptive_core_headless_research_order_count: 1,
	  rts_bot_adaptive_core_headless_researched_rule_ids: ["signal_array"],
	  rts_bot_adaptive_core_headless_research_source_actor_ids: ["town_hall"],
	  rts_bot_adaptive_core_headless_attack_order_count: 1,
	  rts_bot_adaptive_core_headless_micro_move_order_count: 1,
	  rts_bot_adaptive_core_headless_combat_target_actor_ids: ["beacon_pressure_window"],
	  rts_bot_adaptive_core_headless_combat_target_tile_ids: ["9,5"],
	  rts_bot_adaptive_core_headless_combat_formation_ids: ["pullback_rebuild_then_reattack"],
...
jq -n '{
  ...
  rts_bot_map_intel_core_frame_order_stream_sha256: "aa2a7030bec9fb57fe02de2abc05edd23958353666d766168d234a8c16453350",
  rts_bot_map_intel_core_headless_checkpoint_sha256: "d8c97c74c6a2c26b4d5fa159e6359156c54e2cf59329519cf8cf813395364465",
  rts_bot_map_intel_core_frame_order_kind_labels: ["recon", "recon", "recon", "recon", "recon", "move"],
  rts_bot_map_intel_core_headless_applied_order_count: 6,
  rts_bot_map_intel_core_headless_actor_count: 3,
  rts_bot_map_intel_core_headless_final_frame: 1605,
  ...
  rts_bot_map_intel_core_headless_recon_ids: ["three_lane_scout_sweep", "fog_memory_last_seen_grid", "natural_expand_threat", "enemy_signal_array_tech", "hidden_army_fog_gap"],
  rts_bot_map_intel_core_headless_recon_tile_ids: ["5,5", "6,5", "7,5", "8,4", "9,5"],
  rts_bot_map_intel_core_headless_micro_move_order_count: 1,
  rts_bot_map_intel_core_headless_combat_target_tile_ids: ["9,5"],
  rts_bot_map_intel_core_headless_combat_formation_ids: ["rotate_pressure_to_confirmed_beacon"],
  intel_stage_count: 6,
  stage_summaries: [
...
jq -n '{
  ...
  headline: {
    ...
    rts_production_art_replication_first_contact_pack_family_count: 6,
    rts_production_art_replication_first_contact_pack_v3_feature_count: 6,
    rts_production_art_replication_first_contact_pack_v3_gate: true,
    rts_production_art_replication_first_contact_pack_v4_feature_count: 6,
    rts_production_art_replication_first_contact_pack_v4_gate: true,
    rts_production_art_replication_first_contact_pack_v5_feature_count: 6,
    rts_production_art_replication_first_contact_pack_v5_gate: true,
    rts_production_art_replication_first_contact_pack_gate: true,
    rts_production_art_replication_first_contact_terrain_material_pixel_count: 780,
    rts_production_art_replication_first_contact_unit_sprite_skin_pixel_count: 780,
    ...
    rts_production_asset_atlas_first_contact_pack_slot_count: 29,
    rts_production_asset_atlas_first_contact_pack_slot_pixel_count: 13108,
    rts_production_asset_atlas_first_contact_pack_v2_slot_count: 5,
    rts_production_asset_atlas_first_contact_pack_v3_slot_count: 6,
    rts_production_asset_atlas_first_contact_pack_v4_slot_count: 6,
    rts_production_asset_atlas_first_contact_pack_v5_slot_count: 6,
...
jq -e '
  ...
  and ([.failures[].name] | index("cex_adapter_readiness_semantics"))
