...
required_script_lines=(
  ...
  'rts_evidence_continuous_player_flow_review.green == true'
  'rts_evidence_continuous_player_flow_review.source_contract_gate == true'
  'rts_evidence_continuous_player_flow_review.transition_sequence_gate == true'
  'rts_evidence_continuous_player_flow_review.source_headline_gate == true'
  'rts_evidence_continuous_player_flow_review.continuous_player_flow_gate == true'
  'rts_evidence_continuous_player_flow_review_gate == true'
  ...
  'player_first_flow_view_non_background > 300000'
  'player_first_flow_stage_rail > 50000'
...
required_source_lines=(
  ...
  'FLOW_VIEW_WIDTH'
  'player_first_flow_view_non_background'
  'player_first_continuous_flow_screen_gate'
  'continuous_player_flow_steps'
  'transition_sequence'
  'continuous_player_flow_gate'
  'rts_continuous_player_flow_review'
  'rts_evidence_continuous_player_flow_review'
...
required_readiness_lines=(
  ...
  'rts_continuous_player_flow_rts_evidence_review_gate'
  'rts_continuous_player_flow_player_first_flow_view_non_background'
  'bevy-classic-rts-continuous-player-flow.json'
  'bevy-classic-rts-continuous-player-flow.ppm'
)
