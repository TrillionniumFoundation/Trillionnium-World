...
required_lines=(
  ...
  'rts_evidence_release_review_packet_assembly_review_contract'
  'rts_evidence_release_review_packet_assembly_review_gate'
  'RTS evidence packet assembly review checks the manifest'
  ...
  'TRNM_RELEASE_REVIEW_PACKET_USE_RELEASE_ARTIFACT_BIN'
  'Always ask Cargo to refresh the release binary'
  ...
  'release-review-packet-combat-readability-pressure-readiness.log'
  ...
  'check_trillionnium_world_bevy_classic_playtest_handoff_packet.sh'
  ...
  'bevy-visible-button-hit-test-map.json'
  ...
  'Native/Bevy classic RTS session state continuity'
  ...
  'Native/Bevy classic RTS camera/minimap sync'
  'bevy-classic-rts-camera-minimap-sync.json'
	  'native_bevy_classic_rts_camera_minimap_sync_ppm'
	  'Native/Bevy classic RTS camera/minimap sync PPM'
	  ...
	  'Native/Bevy classic RTS full-game visual/UI replication'
	  'bevy-classic-rts-full-game-visual-ui-replication.json'
	  'native_bevy_classic_rts_full_game_visual_ui_replication_ppm'
	  'Native/Bevy classic RTS full-game visual/UI replication PPM'
	  'bevy-classic-rts-full-game-visual-ui-replication.ppm'
	  'native_bevy_classic_rts_openra_screen_for_screen_ui_replication'
	  'Native/Bevy classic RTS OpenRA screen-for-screen UI replication'
	  'bevy-classic-rts-openra-screen-for-screen-ui-replication.json'
	  'native_bevy_classic_rts_openra_screen_for_screen_ui_replication_ppm'
	  'Native/Bevy classic RTS OpenRA screen-for-screen UI replication PPM'
