...
jq -e '
  ...
  and .pixel_counts.player_first_production_terrain_texture > 1000
  and .pixel_counts.player_first_production_transition_tile > 300
  ...
  and .first_contact_production_art_pack_v2_pixel_counts.terrain_texture > 1000
  and .first_contact_production_art_pack_v2_pixel_counts.transition_tile > 300
  ...
  and .first_contact_production_art_pack_v4_pixel_counts.terrain_strata > 1000
  and .first_contact_production_art_pack_v4_pixel_counts.edge_occlusion > 300
  and .first_contact_production_art_pack_v4_pixel_counts.unit_readability_crest > 80
