...
"$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_projectile_ability_semantic_fixture.sh" >"$PACKET_INTEGRITY_PROJECTILE_ABILITY_SEMANTIC_FIXTURE_LOG"
