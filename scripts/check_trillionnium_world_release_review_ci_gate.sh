...
run_check bash_syntax bash -n \
  ...
  "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_rts_semantic_fixture_suite.sh" \
...
run_check packet_integrity_rts_semantic_fixture_suite_gate "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_rts_semantic_fixture_suite.sh"
