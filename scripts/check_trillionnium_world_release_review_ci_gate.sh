...
run_check bash_syntax bash -n \
  ...
  "$ROOT/scripts/check_trillionnium_world_review_residual_queue.sh" \
  "$ROOT/scripts/check_trillionnium_world_review_execution_batches.sh" \
  "$ROOT/scripts/check_trillionnium_world_review_public_boundary_batch.sh" \
  "$ROOT/scripts/check_trillionnium_world_review_release_native_handoff_batch.sh" \
  "$ROOT/scripts/check_trillionnium_world_review_runtime_boundary_batch.sh" \
  ...
  "$ROOT/scripts/check_trillionnium_world_review_rts_evidence_crate_batch.sh" \
  "$ROOT/scripts/check_trillionnium_world_review_evidence_exposure_batch.sh" \
  ...
  "$ROOT/scripts/check_trillionnium_world_review_bot_executor_surface_batch.sh" \
...
run_check bevy_classic_rts_bot_executor_failure_recovery_matrix_gate env \
  TRNM_MULTI_MATCH_BOT_EXECUTOR_EVALUATION_SUMMARY="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-multi-match-bot-executor-evaluation.json" \
  TRNM_MULTI_MATCH_BOT_EXECUTOR_EVALUATION_DIR="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-multi-match-bot-executor-evaluation" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_bot_executor_failure_recovery_matrix.sh"
...
run_check world_review_residual_queue "$ROOT/scripts/check_trillionnium_world_review_residual_queue.sh"
run_check world_review_execution_batches env \
  TRNM_WORLD_REVIEW_EXECUTION_BATCHES_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_execution_batches.sh"
run_check world_review_public_boundary_batch "$ROOT/scripts/check_trillionnium_world_review_public_boundary_batch.sh"
run_check world_review_release_native_handoff_batch env \
  TRNM_WORLD_REVIEW_RELEASE_NATIVE_HANDOFF_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_release_native_handoff_batch.sh"
run_check world_review_runtime_boundary_batch env \
  TRNM_WORLD_REVIEW_RUNTIME_BOUNDARY_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_runtime_boundary_batch.sh"
run_check world_review_runtime_core_semantics_batch env \
  TRNM_WORLD_REVIEW_RUNTIME_CORE_SEMANTICS_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_runtime_core_semantics_batch.sh"
run_check world_review_runtime_adapter_online_batch env \
...
run_check world_review_first_contact_rts_data_batch env \
  ...
  "$ROOT/scripts/check_trillionnium_world_review_first_contact_rts_data_batch.sh"
run_check world_review_rts_evidence_crate_batch env \
  TRNM_WORLD_REVIEW_RTS_EVIDENCE_CRATE_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_rts_evidence_crate_batch.sh"
run_check world_review_evidence_exposure_batch env \
  TRNM_WORLD_REVIEW_EVIDENCE_EXPOSURE_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_evidence_exposure_batch.sh"
run_check world_review_bevy_runtime_renderer_batch env \
  TRNM_WORLD_REVIEW_BEVY_RUNTIME_RENDERER_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_bevy_runtime_renderer_batch.sh"
run_check world_review_first_contact_player_surface_cues_batch env \
...
run_check world_review_docs_plan_truth_source_batch env \
  ...
  "$ROOT/scripts/check_trillionnium_world_review_docs_plan_truth_source_batch.sh"
run_check world_review_bot_executor_surface_batch env \
