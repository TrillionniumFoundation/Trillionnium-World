...
run_check bash_syntax bash -n \
  ...
  "$ROOT/scripts/v2/bevy_release_ci_artifact_wrapper_script_contract_guard_test.sh" \
  ...
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_production_art_replication.sh" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_production_asset_atlas.sh" \
  ...
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_campaign_outcome_ui_readiness.sh" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_campaign_ui_continuity.sh" \
  ...
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_screen_for_screen_ui_replication.sh" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_engine_port_asset_parity.sh" \
  ...
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_artifact_bundle.sh" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_review_capsule.sh" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_review_receipt.sh" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_review_digest.sh" \
  ...
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_production_desktop_review_packet.sh" \
  ...
  "$ROOT/scripts/v2/bevy_classic_rts_production_art_replication_script_contract_guard_test.sh" \
  "$ROOT/scripts/v2/bevy_classic_rts_production_asset_atlas_script_contract_guard_test.sh" \
  "$ROOT/scripts/v2/bevy_classic_rts_production_ui_skin_script_contract_guard_test.sh" \
  ...
  "$ROOT/scripts/v2/bevy_classic_rts_campaign_ui_continuity_script_contract_guard_test.sh" \
  ...
  "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_artifact_bundle_script_contract_guard_test.sh" \
  "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_review_capsule_script_contract_guard_test.sh" \
  "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_review_receipt_script_contract_guard_test.sh" \
  "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_review_digest_script_contract_guard_test.sh" \
  ...
  "$ROOT/scripts/v2/bevy_classic_rts_production_desktop_review_packet_script_contract_guard_test.sh" \
...
run_check packet_integrity_bot_executor_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_bot_executor_semantic_guard_test.sh"
run_check packet_integrity_bot_executor_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_bot_executor_semantic_fixture.sh"
run_check packet_integrity_bot_executor_matrix_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_bot_executor_matrix_semantic_guard_test.sh"
run_check packet_integrity_bot_executor_matrix_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_bot_executor_matrix_semantic_fixture.sh"
run_check packet_integrity_bot_gap_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_bot_gap_semantic_guard_test.sh"
run_check packet_integrity_bot_gap_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_bot_gap_semantic_fixture.sh"
run_check packet_integrity_control_loop_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_control_loop_semantic_guard_test.sh"
run_check packet_integrity_control_loop_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_control_loop_semantic_fixture.sh"
run_check packet_integrity_selection_minimap_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_selection_minimap_semantic_guard_test.sh"
run_check packet_integrity_selection_minimap_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_selection_minimap_semantic_fixture.sh"
run_check packet_integrity_build_lifecycle_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_build_lifecycle_semantic_guard_test.sh"
run_check packet_integrity_build_lifecycle_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_build_lifecycle_semantic_fixture.sh"
run_check packet_integrity_tech_tree_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_tech_tree_semantic_guard_test.sh"
run_check packet_integrity_tech_tree_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_tech_tree_semantic_fixture.sh"
run_check packet_integrity_projectile_ability_semantic_guard env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/v2/release_review_packet_integrity_projectile_ability_semantic_guard_test.sh"
run_check packet_integrity_projectile_ability_semantic_fixture_gate env TRNM_RELEASE_REVIEW_PACKET_INTEGRITY_SOURCE_CHAIN_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_release_review_packet_integrity_projectile_ability_semantic_fixture.sh"
...
run_check bevy_release_ci_artifact_wrapper_contract_guard "$ROOT/scripts/v2/bevy_release_ci_artifact_wrapper_script_contract_guard_test.sh"
...
# Bevy classic OpenRA imported replay artifact bundle contract: trillionnium_world_bevy_classic_rts_openra_imported_replay_artifact_bundle_v1
# Bevy classic OpenRA imported replay review capsule contract: trillionnium_world_bevy_classic_rts_openra_imported_replay_review_capsule_v1
# Bevy classic OpenRA imported replay review receipt contract: trillionnium_world_bevy_classic_rts_openra_imported_replay_review_receipt_v1
# Bevy classic OpenRA imported replay review digest contract: trillionnium_world_bevy_classic_rts_openra_imported_replay_review_digest_v1
...
run_check bevy_classic_rts_production_art_replication_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_production_art_replication_script_contract_guard_test.sh"
run_check bevy_classic_rts_production_art_replication_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_production_art_replication.sh"
...
run_check bevy_classic_rts_production_interaction_polish_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_production_interaction_polish.sh"
# Full screen/UI replication contract: trillionnium_world_bevy_classic_rts_full_screen_ui_replication_v1
run_check bevy_classic_rts_full_screen_ui_replication_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_full_screen_ui_replication_script_contract_guard_test.sh"
run_check bevy_classic_rts_full_screen_ui_replication_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_full_screen_ui_replication.sh"
...
# Campaign UI continuity contract: trillionnium_world_bevy_classic_rts_campaign_ui_continuity_v1
run_check bevy_classic_rts_campaign_ui_continuity_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_campaign_ui_continuity_script_contract_guard_test.sh"
run_check bevy_classic_rts_campaign_ui_continuity_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_campaign_ui_continuity.sh"
# In-match HUD/state replication contract: trillionnium_world_bevy_classic_rts_in_match_hud_state_replication_v1
run_check bevy_classic_rts_in_match_hud_state_replication_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_in_match_hud_state_replication_script_contract_guard_test.sh"
run_check bevy_classic_rts_in_match_hud_state_replication_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_in_match_hud_state_replication.sh"
# Session state continuity contract: trillionnium_world_bevy_classic_rts_session_state_continuity_v1
run_check bevy_classic_rts_session_state_continuity_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_session_state_continuity_script_contract_guard_test.sh"
run_check bevy_classic_rts_session_state_continuity_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_session_state_continuity.sh"
...
# OpenRA screen-for-screen UI replication contract: trillionnium_world_bevy_classic_rts_openra_screen_for_screen_ui_replication_v1
run_check bevy_classic_rts_openra_screen_for_screen_ui_replication_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_openra_screen_for_screen_ui_replication_script_contract_guard_test.sh"
run_check bevy_classic_rts_openra_screen_for_screen_ui_replication_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_screen_for_screen_ui_replication.sh"
# OpenRA engine port asset parity contract: trillionnium_world_bevy_classic_rts_openra_engine_port_asset_parity_v1
run_check bevy_classic_rts_openra_engine_port_asset_parity_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_openra_engine_port_asset_parity_script_contract_guard_test.sh"
run_check bevy_classic_rts_openra_engine_port_asset_parity_gate "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_engine_port_asset_parity.sh"
...
run_check bevy_classic_rts_openra_imported_headless_comparison_harness_gate env \
  ...
  TRNM_OPENRA_IMPORTED_REPLAY_REDUCER_DIR="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-reducer" \
...
run_check bevy_classic_rts_openra_imported_replay_audit_ledger_gate env \
...
run_check bevy_classic_rts_openra_imported_replay_repro_manifest_gate env \
  TRNM_OPENRA_IMPORTED_HEADLESS_COMPARISON_SUMMARY="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-headless-comparison-harness.json" \
  TRNM_OPENRA_IMPORTED_HEADLESS_COMPARISON_DIR="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-headless-comparison-harness" \
  ...
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_repro_manifest.sh"
run_check bevy_classic_rts_openra_imported_replay_artifact_bundle_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_artifact_bundle_script_contract_guard_test.sh"
run_check bevy_classic_rts_openra_imported_replay_artifact_bundle_gate env \
  TRNM_OPENRA_IMPORTED_REPLAY_REPRO_SUMMARY="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-repro-manifest.json" \
  TRNM_OPENRA_IMPORTED_REPLAY_REPRO_DIR="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-repro-manifest" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_artifact_bundle.sh"
run_check bevy_classic_rts_openra_imported_replay_review_capsule_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_review_capsule_script_contract_guard_test.sh"
run_check bevy_classic_rts_openra_imported_replay_review_capsule_gate env \
  TRNM_OPENRA_IMPORTED_REPLAY_ARTIFACT_BUNDLE_SUMMARY="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-artifact-bundle.json" \
  TRNM_OPENRA_IMPORTED_REPLAY_ARTIFACT_BUNDLE_DIR="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-artifact-bundle" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_review_capsule.sh"
run_check bevy_classic_rts_openra_imported_replay_review_receipt_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_review_receipt_script_contract_guard_test.sh"
run_check bevy_classic_rts_openra_imported_replay_review_receipt_gate env \
  TRNM_OPENRA_IMPORTED_REPLAY_REVIEW_CAPSULE_SUMMARY="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-review-capsule.json" \
  TRNM_OPENRA_IMPORTED_REPLAY_REVIEW_CAPSULE_DIR="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-review-capsule" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_review_receipt.sh"
run_check bevy_classic_rts_openra_imported_replay_review_digest_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_openra_imported_replay_review_digest_script_contract_guard_test.sh"
run_check bevy_classic_rts_openra_imported_replay_review_digest_gate env \
  TRNM_OPENRA_IMPORTED_REPLAY_REVIEW_RECEIPT_SUMMARY="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-review-receipt.json" \
  TRNM_OPENRA_IMPORTED_REPLAY_REVIEW_RECEIPT_DIR="$ROOT/acceptance/S5_native_bevy_device/latest/bevy-classic-rts-openra-imported-replay-review-receipt" \
  "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_openra_imported_replay_review_digest.sh"
...
run_check bevy_classic_rts_production_desktop_review_packet_contract_guard "$ROOT/scripts/v2/bevy_classic_rts_production_desktop_review_packet_script_contract_guard_test.sh"
run_check bevy_classic_rts_production_desktop_review_packet_gate env TRNM_WORLD_RTS_PRODUCTION_DESKTOP_REVIEW_REFRESH=0 "$ROOT/scripts/check_trillionnium_world_bevy_classic_rts_production_desktop_review_packet.sh"
