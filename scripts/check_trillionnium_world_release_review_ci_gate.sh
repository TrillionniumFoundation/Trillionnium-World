...
# Bevy classic low-spec asset contracts: trillionnium_world_bevy_classic_asset_pack_v1 / trillionnium_world_bevy_classic_manifest_lint_v1 / trillionnium_world_bevy_classic_animation_preview_v1 / trillionnium_world_bevy_classic_animation_selector_v1 / trillionnium_world_bevy_classic_player_motion_probe_v1 / trillionnium_world_bevy_classic_input_frame_budget_v1 / trillionnium_world_bevy_classic_render_budget_v1 / trillionnium_world_bevy_classic_scene_preview_v1 / trillionnium_world_bevy_classic_model_catalog_v1 / trillionnium_world_bevy_classic_renderer_probe_v1 / trillionnium_world_bevy_classic_playtest_readiness_v1 / trillionnium_world_bevy_classic_playtest_runner_status_v1
