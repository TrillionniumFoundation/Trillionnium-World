...
require_file "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC"
...
require_text "$DOC" "trillionnium-world-review-generated-count-surface-batch-2026-07-09.md"
...
require_text "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_DOC" "Status: local review First Contact RTS data extraction sub-batch 4."
require_text "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_DOC" "first_contact_rts_data_extraction"
require_text "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_DOC" "sub_batch_4_exit_rule_satisfied=true"
require_text "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_DOC" "sub_batch_5_unblocked_for_local_review=true"
require_text "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_DOC" "batch_4_unblocked_for_local_review=false"
require_text "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_DOC" "Status: local review RTS evidence crate boundary sub-batch 5."
require_text "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_DOC" "rts_evidence_crate_boundary"
require_text "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_DOC" "sub_batch_5_exit_rule_satisfied=true"
require_text "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_DOC" "sub_batch_6_unblocked_for_local_review=true"
require_text "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_DOC" "batch_4_unblocked_for_local_review=false"
require_text "$REVIEW_EVIDENCE_EXPOSURE_BATCH_DOC" "Status: local review evidence exposure boundary sub-batch 6."
require_text "$REVIEW_EVIDENCE_EXPOSURE_BATCH_DOC" "review_evidence_exposure_boundary"
...
require_text "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_DOC" "Status: local review generated count surface batch 4."
require_text "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_DOC" "unclassified_generated_count_surface"
require_text "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_DOC" 'Reviewed commit count: `14`'
require_text "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_DOC" 'Per-count unresolved owner assignment count: `0`'
require_text "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_DOC" "count_contract_owner_assignment_complete=true"
require_text "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_DOC" "owning_checker_artifact_binding_complete=true"
...
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "Status: local review bot/executor surface batch 6."
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "unclassified_bot_executor_surface"
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" 'Reviewed commit count: `10`'
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" 'Unresolved bot/executor surface route count: `0`'
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "bot_executor_surface_route_complete=true"
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "packet_semantic_fixture_owner_bound=true"
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "rts_runtime_data_boundary_preserved=true"
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "release_evidence_contract_bound=true"
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "batch_6_exit_rule_satisfied=true"
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "batch_7_unblocked_for_local_review=true"
require_text "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC" "next_batch_bucket_id=unclassified_classic_evidence_surface"
...
refresh_input env TRNM_WORLD_REVIEW_GENERATED_COUNT_SURFACE_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_generated_count_surface_batch.sh" >/dev/null
require_file "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON"
jq -e '
...
refresh_input env TRNM_WORLD_REVIEW_BOT_EXECUTOR_SURFACE_BATCH_REFRESH_INPUTS=0 \
  "$ROOT/scripts/check_trillionnium_world_review_bot_executor_surface_batch.sh" >/dev/null
require_file "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON"
jq -e '
...
review_first_contact_rts_data_batch_status="$(jq -r '.status // "missing"' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_reviewed_commit_count="$(jq -r '.reviewed_commit_count // 0' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_unresolved_count="$(jq -r '.unresolved_commit_review_count // 999' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_batch3_reviewed_count="$(jq -r '.batch_3_reviewed_commit_count // 0' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_batch3_remaining_count="$(jq -r '.batch_3_remaining_commit_level_review_count // 999' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_local_review_complete="$(jq -r 'if has("sub_batch_4_local_review_complete") then .sub_batch_4_local_review_complete else false end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_exit_rule_satisfied="$(jq -r 'if has("sub_batch_4_exit_rule_satisfied") then .sub_batch_4_exit_rule_satisfied else false end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_next_unblocked="$(jq -r 'if has("sub_batch_5_unblocked_for_local_review") then .sub_batch_5_unblocked_for_local_review else false end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_batch3_exit_rule_satisfied="$(jq -r 'if has("batch_3_exit_rule_satisfied") then .batch_3_exit_rule_satisfied else true end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_batch4_unblocked="$(jq -r 'if has("batch_4_unblocked_for_local_review") then .batch_4_unblocked_for_local_review else true end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_next_sub_batch_id="$(jq -r '.next_sub_batch_id // "missing"' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_basin_green="$(jq -r 'if has("basin_spec_green") then .basin_spec_green else false end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_renderer_neutral="$(jq -r 'if has("rts_data_profiles_renderer_neutral") then .rts_data_profiles_renderer_neutral else false end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_draw_math_moved="$(jq -r 'if has("renderer_draw_math_moved_to_rts_data") then .renderer_draw_math_moved_to_rts_data else true end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_live_renderer_moved="$(jq -r 'if has("live_bevy_renderer_behavior_moved_to_rts_data") then .live_bevy_renderer_behavior_moved_to_rts_data else true end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_external_action_performed="$(jq -r 'if has("external_action_performed") then .external_action_performed else true end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_first_contact_rts_data_batch_history_rewrite_performed="$(jq -r 'if has("history_rewrite_performed") then .history_rewrite_performed else true end' "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_JSON")"
review_rts_evidence_crate_batch_status="$(jq -r '.status // "missing"' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_reviewed_commit_count="$(jq -r '.reviewed_commit_count // 0' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_unresolved_count="$(jq -r '.unresolved_commit_review_count // 999' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_batch3_reviewed_count="$(jq -r '.batch_3_reviewed_commit_count // 0' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_batch3_remaining_count="$(jq -r '.batch_3_remaining_commit_level_review_count // 999' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_local_review_complete="$(jq -r 'if has("sub_batch_5_local_review_complete") then .sub_batch_5_local_review_complete else false end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_exit_rule_satisfied="$(jq -r 'if has("sub_batch_5_exit_rule_satisfied") then .sub_batch_5_exit_rule_satisfied else false end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_next_unblocked="$(jq -r 'if has("sub_batch_6_unblocked_for_local_review") then .sub_batch_6_unblocked_for_local_review else false end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_batch3_exit_rule_satisfied="$(jq -r 'if has("batch_3_exit_rule_satisfied") then .batch_3_exit_rule_satisfied else true end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_batch4_unblocked="$(jq -r 'if has("batch_4_unblocked_for_local_review") then .batch_4_unblocked_for_local_review else true end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_next_sub_batch_id="$(jq -r '.next_sub_batch_id // "missing"' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_evidence_guard_all_green="$(jq -r 'if has("evidence_guard_all_green") then .evidence_guard_all_green else false end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_controls_runtime="$(jq -r 'if has("evidence_crate_controls_playable_runtime") then .evidence_crate_controls_playable_runtime else true end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_renderer_ownership_claimed="$(jq -r 'if has("playable_renderer_ownership_claimed") then .playable_renderer_ownership_claimed else true end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_live_renderer_moved="$(jq -r 'if has("live_bevy_renderer_behavior_moved_to_rts_evidence") then .live_bevy_renderer_behavior_moved_to_rts_evidence else true end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_external_action_performed="$(jq -r 'if has("external_action_performed") then .external_action_performed else true end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_rts_evidence_crate_batch_history_rewrite_performed="$(jq -r 'if has("history_rewrite_performed") then .history_rewrite_performed else true end' "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_JSON")"
review_evidence_exposure_batch_status="$(jq -r '.status // "missing"' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_reviewed_commit_count="$(jq -r '.reviewed_commit_count // 0' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_unresolved_count="$(jq -r '.unresolved_commit_review_count // 999' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_batch3_reviewed_count="$(jq -r '.batch_3_reviewed_commit_count // 0' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_batch3_remaining_count="$(jq -r '.batch_3_remaining_commit_level_review_count // 999' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_local_review_complete="$(jq -r 'if has("sub_batch_6_local_review_complete") then .sub_batch_6_local_review_complete else false end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_exit_rule_satisfied="$(jq -r 'if has("sub_batch_6_exit_rule_satisfied") then .sub_batch_6_exit_rule_satisfied else false end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_next_unblocked="$(jq -r 'if has("sub_batch_7_unblocked_for_local_review") then .sub_batch_7_unblocked_for_local_review else false end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_batch3_exit_rule_satisfied="$(jq -r 'if has("batch_3_exit_rule_satisfied") then .batch_3_exit_rule_satisfied else true end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_batch4_unblocked="$(jq -r 'if has("batch_4_unblocked_for_local_review") then .batch_4_unblocked_for_local_review else true end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_next_sub_batch_id="$(jq -r '.next_sub_batch_id // "missing"' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_runtime_review_gate="$(jq -r 'if has("first_contact_runtime_review_gate") then .first_contact_runtime_review_gate else false end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_visual_flow_counts_exposed="$(jq -r 'if has("classic_visual_flow_counts_exposed") then .classic_visual_flow_counts_exposed else false end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_packet_assembly_exposed="$(jq -r 'if has("packet_assembly_review_exposed") then .packet_assembly_review_exposed else false end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_local_only="$(jq -r 'if has("exposed_review_artifacts_local_only") then .exposed_review_artifacts_local_only else false end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_renderer_ownership_claimed="$(jq -r 'if has("playable_renderer_ownership_claimed") then .playable_renderer_ownership_claimed else true end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
review_evidence_exposure_batch_render_world_claimed="$(jq -r 'if has("render_world_extraction_complete_claimed") then .render_world_extraction_complete_claimed else true end' "$REVIEW_EVIDENCE_EXPOSURE_BATCH_JSON")"
...
review_generated_count_surface_batch_status="$(jq -r '.status // "missing"' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_reviewed_commit_count="$(jq -r '.reviewed_commit_count // 0' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_unresolved_count="$(jq -r '.unresolved_generated_count_surface_review_count // 999' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_owner_assignment_complete="$(jq -r 'if has("count_contract_owner_assignment_complete") then .count_contract_owner_assignment_complete else false end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_binding_complete="$(jq -r 'if has("owning_checker_artifact_binding_complete") then .owning_checker_artifact_binding_complete else false end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_release_ci_guard_bound="$(jq -r 'if has("release_ci_count_guard_bound") then .release_ci_count_guard_bound else false end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_packet_guard_bound="$(jq -r 'if has("packet_semantic_count_guard_bound") then .packet_semantic_count_guard_bound else false end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_prior_batch3_closed="$(jq -r 'if has("prior_batch_3_closed") then .prior_batch_3_closed else false end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_exit_rule_satisfied="$(jq -r 'if has("batch_4_exit_rule_satisfied") then .batch_4_exit_rule_satisfied else false end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_batch5_unblocked="$(jq -r 'if has("batch_5_unblocked_for_local_review") then .batch_5_unblocked_for_local_review else false end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_next_batch_bucket_id="$(jq -r '.next_batch_bucket_id // "missing"' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
review_generated_count_surface_batch_public_launch_claimed="$(jq -r 'if has("public_launch_ready_claimed") then .public_launch_ready_claimed else true end' "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_JSON")"
...
review_bot_executor_surface_batch_status="$(jq -r '.status // "missing"' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_reviewed_commit_count="$(jq -r '.reviewed_commit_count // 0' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_unresolved_count="$(jq -r '.unresolved_bot_executor_surface_review_count // 999' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_route_complete="$(jq -r 'if has("bot_executor_surface_route_complete") then .bot_executor_surface_route_complete else false end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_packet_fixture_bound="$(jq -r 'if has("packet_semantic_fixture_owner_bound") then .packet_semantic_fixture_owner_bound else false end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_runtime_boundary_preserved="$(jq -r 'if has("rts_runtime_data_boundary_preserved") then .rts_runtime_data_boundary_preserved else false end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_release_evidence_bound="$(jq -r 'if has("release_evidence_contract_bound") then .release_evidence_contract_bound else false end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_prior_batch5_closed="$(jq -r 'if has("prior_batch_5_closed") then .prior_batch_5_closed else false end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_exit_rule_satisfied="$(jq -r 'if has("batch_6_exit_rule_satisfied") then .batch_6_exit_rule_satisfied else false end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_batch7_unblocked="$(jq -r 'if has("batch_7_unblocked_for_local_review") then .batch_7_unblocked_for_local_review else false end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_next_batch_bucket_id="$(jq -r '.next_batch_bucket_id // "missing"' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_bevy_integration_claimed="$(jq -r 'if has("bevy_integration_ownership_claimed") then .bevy_integration_ownership_claimed else true end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_public_launch_claimed="$(jq -r 'if has("public_launch_ready_claimed") then .public_launch_ready_claimed else true end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_android_s5_claimed="$(jq -r 'if has("android_s5_real_device_claimed") then .android_s5_real_device_claimed else true end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_external_action_performed="$(jq -r 'if has("external_action_performed") then .external_action_performed else true end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
review_bot_executor_surface_batch_history_rewrite_performed="$(jq -r 'if has("history_rewrite_performed") then .history_rewrite_performed else true end' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_JSON")"
...
jq -n \
  ...
  --arg review_first_contact_rts_data_batch_doc "$REVIEW_FIRST_CONTACT_RTS_DATA_BATCH_DOC_REL" \
  --arg review_rts_evidence_crate_batch_doc "$REVIEW_RTS_EVIDENCE_CRATE_BATCH_DOC_REL" \
  --arg review_evidence_exposure_batch_doc "$REVIEW_EVIDENCE_EXPOSURE_BATCH_DOC_REL" \
  ...
  --arg review_first_contact_rts_data_batch_status "$review_first_contact_rts_data_batch_status" \
  --arg review_first_contact_rts_data_batch_next_sub_batch_id "$review_first_contact_rts_data_batch_next_sub_batch_id" \
  --arg review_rts_evidence_crate_batch_status "$review_rts_evidence_crate_batch_status" \
  ...
  --arg review_bot_executor_surface_batch_doc "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC_REL" \
  --arg review_bot_executor_surface_batch_status "$review_bot_executor_surface_batch_status" \
  --arg review_bot_executor_surface_batch_next_batch_bucket_id "$review_bot_executor_surface_batch_next_batch_bucket_id" \
  ...
  --argjson review_first_contact_rts_data_batch_reviewed_commit_count "$review_first_contact_rts_data_batch_reviewed_commit_count" \
  --argjson review_first_contact_rts_data_batch_unresolved_count "$review_first_contact_rts_data_batch_unresolved_count" \
  --argjson review_first_contact_rts_data_batch_batch3_reviewed_count "$review_first_contact_rts_data_batch_batch3_reviewed_count" \
  --argjson review_first_contact_rts_data_batch_batch3_remaining_count "$review_first_contact_rts_data_batch_batch3_remaining_count" \
  --argjson review_first_contact_rts_data_batch_local_review_complete "$review_first_contact_rts_data_batch_local_review_complete" \
  --argjson review_first_contact_rts_data_batch_exit_rule_satisfied "$review_first_contact_rts_data_batch_exit_rule_satisfied" \
  --argjson review_first_contact_rts_data_batch_next_unblocked "$review_first_contact_rts_data_batch_next_unblocked" \
  --argjson review_first_contact_rts_data_batch_batch3_exit_rule_satisfied "$review_first_contact_rts_data_batch_batch3_exit_rule_satisfied" \
  --argjson review_first_contact_rts_data_batch_batch4_unblocked "$review_first_contact_rts_data_batch_batch4_unblocked" \
  --argjson review_first_contact_rts_data_batch_basin_green "$review_first_contact_rts_data_batch_basin_green" \
  --argjson review_first_contact_rts_data_batch_renderer_neutral "$review_first_contact_rts_data_batch_renderer_neutral" \
  --argjson review_first_contact_rts_data_batch_draw_math_moved "$review_first_contact_rts_data_batch_draw_math_moved" \
  --argjson review_first_contact_rts_data_batch_live_renderer_moved "$review_first_contact_rts_data_batch_live_renderer_moved" \
  --argjson review_first_contact_rts_data_batch_external_action_performed "$review_first_contact_rts_data_batch_external_action_performed" \
  --argjson review_first_contact_rts_data_batch_history_rewrite_performed "$review_first_contact_rts_data_batch_history_rewrite_performed" \
  --argjson review_rts_evidence_crate_batch_reviewed_commit_count "$review_rts_evidence_crate_batch_reviewed_commit_count" \
  --argjson review_rts_evidence_crate_batch_unresolved_count "$review_rts_evidence_crate_batch_unresolved_count" \
  --argjson review_rts_evidence_crate_batch_batch3_reviewed_count "$review_rts_evidence_crate_batch_batch3_reviewed_count" \
  --argjson review_rts_evidence_crate_batch_batch3_remaining_count "$review_rts_evidence_crate_batch_batch3_remaining_count" \
  --argjson review_rts_evidence_crate_batch_local_review_complete "$review_rts_evidence_crate_batch_local_review_complete" \
  --argjson review_rts_evidence_crate_batch_exit_rule_satisfied "$review_rts_evidence_crate_batch_exit_rule_satisfied" \
  --argjson review_rts_evidence_crate_batch_next_unblocked "$review_rts_evidence_crate_batch_next_unblocked" \
  --argjson review_rts_evidence_crate_batch_batch3_exit_rule_satisfied "$review_rts_evidence_crate_batch_batch3_exit_rule_satisfied" \
  --argjson review_rts_evidence_crate_batch_batch4_unblocked "$review_rts_evidence_crate_batch_batch4_unblocked" \
  --argjson review_rts_evidence_crate_batch_evidence_guard_all_green "$review_rts_evidence_crate_batch_evidence_guard_all_green" \
  --argjson review_rts_evidence_crate_batch_controls_runtime "$review_rts_evidence_crate_batch_controls_runtime" \
  --argjson review_rts_evidence_crate_batch_renderer_ownership_claimed "$review_rts_evidence_crate_batch_renderer_ownership_claimed" \
  --argjson review_rts_evidence_crate_batch_live_renderer_moved "$review_rts_evidence_crate_batch_live_renderer_moved" \
  --argjson review_rts_evidence_crate_batch_external_action_performed "$review_rts_evidence_crate_batch_external_action_performed" \
  --argjson review_rts_evidence_crate_batch_history_rewrite_performed "$review_rts_evidence_crate_batch_history_rewrite_performed" \
  --argjson review_evidence_exposure_batch_reviewed_commit_count "$review_evidence_exposure_batch_reviewed_commit_count" \
  --argjson review_evidence_exposure_batch_unresolved_count "$review_evidence_exposure_batch_unresolved_count" \
  --argjson review_evidence_exposure_batch_batch3_reviewed_count "$review_evidence_exposure_batch_batch3_reviewed_count" \
  --argjson review_evidence_exposure_batch_batch3_remaining_count "$review_evidence_exposure_batch_batch3_remaining_count" \
  --argjson review_evidence_exposure_batch_local_review_complete "$review_evidence_exposure_batch_local_review_complete" \
  --argjson review_evidence_exposure_batch_exit_rule_satisfied "$review_evidence_exposure_batch_exit_rule_satisfied" \
  --argjson review_evidence_exposure_batch_next_unblocked "$review_evidence_exposure_batch_next_unblocked" \
  --argjson review_evidence_exposure_batch_batch3_exit_rule_satisfied "$review_evidence_exposure_batch_batch3_exit_rule_satisfied" \
  --argjson review_evidence_exposure_batch_batch4_unblocked "$review_evidence_exposure_batch_batch4_unblocked" \
  --argjson review_evidence_exposure_batch_runtime_review_gate "$review_evidence_exposure_batch_runtime_review_gate" \
  --argjson review_evidence_exposure_batch_visual_flow_counts_exposed "$review_evidence_exposure_batch_visual_flow_counts_exposed" \
  --argjson review_evidence_exposure_batch_packet_assembly_exposed "$review_evidence_exposure_batch_packet_assembly_exposed" \
  --argjson review_evidence_exposure_batch_local_only "$review_evidence_exposure_batch_local_only" \
  --argjson review_evidence_exposure_batch_renderer_ownership_claimed "$review_evidence_exposure_batch_renderer_ownership_claimed" \
  --argjson review_evidence_exposure_batch_render_world_claimed "$review_evidence_exposure_batch_render_world_claimed" \
  ...
  --argjson review_generated_count_surface_batch_reviewed_commit_count "$review_generated_count_surface_batch_reviewed_commit_count" \
  --argjson review_generated_count_surface_batch_unresolved_count "$review_generated_count_surface_batch_unresolved_count" \
  --argjson review_generated_count_surface_batch_owner_assignment_complete "$review_generated_count_surface_batch_owner_assignment_complete" \
  --argjson review_generated_count_surface_batch_binding_complete "$review_generated_count_surface_batch_binding_complete" \
  --argjson review_generated_count_surface_batch_release_ci_guard_bound "$review_generated_count_surface_batch_release_ci_guard_bound" \
  --argjson review_generated_count_surface_batch_packet_guard_bound "$review_generated_count_surface_batch_packet_guard_bound" \
  --argjson review_generated_count_surface_batch_prior_batch3_closed "$review_generated_count_surface_batch_prior_batch3_closed" \
  --argjson review_generated_count_surface_batch_exit_rule_satisfied "$review_generated_count_surface_batch_exit_rule_satisfied" \
  --argjson review_generated_count_surface_batch_batch5_unblocked "$review_generated_count_surface_batch_batch5_unblocked" \
  --argjson review_generated_count_surface_batch_public_launch_claimed "$review_generated_count_surface_batch_public_launch_claimed" \
  ...
  --argjson review_bot_executor_surface_batch_reviewed_commit_count "$review_bot_executor_surface_batch_reviewed_commit_count" \
  --argjson review_bot_executor_surface_batch_unresolved_count "$review_bot_executor_surface_batch_unresolved_count" \
  --argjson review_bot_executor_surface_batch_route_complete "$review_bot_executor_surface_batch_route_complete" \
  --argjson review_bot_executor_surface_batch_packet_fixture_bound "$review_bot_executor_surface_batch_packet_fixture_bound" \
  --argjson review_bot_executor_surface_batch_runtime_boundary_preserved "$review_bot_executor_surface_batch_runtime_boundary_preserved" \
  --argjson review_bot_executor_surface_batch_release_evidence_bound "$review_bot_executor_surface_batch_release_evidence_bound" \
  --argjson review_bot_executor_surface_batch_prior_batch5_closed "$review_bot_executor_surface_batch_prior_batch5_closed" \
  --argjson review_bot_executor_surface_batch_exit_rule_satisfied "$review_bot_executor_surface_batch_exit_rule_satisfied" \
  --argjson review_bot_executor_surface_batch_batch7_unblocked "$review_bot_executor_surface_batch_batch7_unblocked" \
  --argjson review_bot_executor_surface_batch_bevy_integration_claimed "$review_bot_executor_surface_batch_bevy_integration_claimed" \
  --argjson review_bot_executor_surface_batch_public_launch_claimed "$review_bot_executor_surface_batch_public_launch_claimed" \
  --argjson review_bot_executor_surface_batch_android_s5_claimed "$review_bot_executor_surface_batch_android_s5_claimed" \
  --argjson review_bot_executor_surface_batch_external_action_performed "$review_bot_executor_surface_batch_external_action_performed" \
  --argjson review_bot_executor_surface_batch_history_rewrite_performed "$review_bot_executor_surface_batch_history_rewrite_performed" \
  ...
  '{
    ...
    review_first_contact_rts_data_batch: {
      doc_path: $review_first_contact_rts_data_batch_doc,
      artifact_path: "acceptance/S6_public_launch/latest/trillionnium-world-review-first-contact-rts-data-batch.json",
      status: $review_first_contact_rts_data_batch_status,
      batch_order: 3,
      sub_batch_order: 4,
      sub_batch_id: "first_contact_rts_data_extraction",
      reviewed_commit_count: $review_first_contact_rts_data_batch_reviewed_commit_count,
      unresolved_commit_review_count: $review_first_contact_rts_data_batch_unresolved_count,
      batch_3_reviewed_commit_count: $review_first_contact_rts_data_batch_batch3_reviewed_count,
      batch_3_remaining_commit_level_review_count: $review_first_contact_rts_data_batch_batch3_remaining_count,
      sub_batch_4_local_review_complete: $review_first_contact_rts_data_batch_local_review_complete,
      sub_batch_4_exit_rule_satisfied: $review_first_contact_rts_data_batch_exit_rule_satisfied,
      sub_batch_5_unblocked_for_local_review: $review_first_contact_rts_data_batch_next_unblocked,
      batch_3_exit_rule_satisfied: $review_first_contact_rts_data_batch_batch3_exit_rule_satisfied,
      batch_4_unblocked_for_local_review: $review_first_contact_rts_data_batch_batch4_unblocked,
      next_sub_batch_id: $review_first_contact_rts_data_batch_next_sub_batch_id,
      basin_spec_green: $review_first_contact_rts_data_batch_basin_green,
      rts_data_profiles_renderer_neutral: $review_first_contact_rts_data_batch_renderer_neutral,
      renderer_draw_math_moved_to_rts_data: $review_first_contact_rts_data_batch_draw_math_moved,
      live_bevy_renderer_behavior_moved_to_rts_data: $review_first_contact_rts_data_batch_live_renderer_moved,
      external_action_performed: $review_first_contact_rts_data_batch_external_action_performed,
      history_rewrite_performed: $review_first_contact_rts_data_batch_history_rewrite_performed,
    ...
    review_rts_evidence_crate_batch: {
      doc_path: $review_rts_evidence_crate_batch_doc,
      artifact_path: "acceptance/S6_public_launch/latest/trillionnium-world-review-rts-evidence-crate-batch.json",
      status: $review_rts_evidence_crate_batch_status,
      batch_order: 3,
      sub_batch_order: 5,
      sub_batch_id: "rts_evidence_crate_boundary",
      reviewed_commit_count: $review_rts_evidence_crate_batch_reviewed_commit_count,
      unresolved_commit_review_count: $review_rts_evidence_crate_batch_unresolved_count,
      batch_3_reviewed_commit_count: $review_rts_evidence_crate_batch_batch3_reviewed_count,
      batch_3_remaining_commit_level_review_count: $review_rts_evidence_crate_batch_batch3_remaining_count,
      sub_batch_5_local_review_complete: $review_rts_evidence_crate_batch_local_review_complete,
      sub_batch_5_exit_rule_satisfied: $review_rts_evidence_crate_batch_exit_rule_satisfied,
      sub_batch_6_unblocked_for_local_review: $review_rts_evidence_crate_batch_next_unblocked,
      batch_3_exit_rule_satisfied: $review_rts_evidence_crate_batch_batch3_exit_rule_satisfied,
      batch_4_unblocked_for_local_review: $review_rts_evidence_crate_batch_batch4_unblocked,
      next_sub_batch_id: $review_rts_evidence_crate_batch_next_sub_batch_id,
      evidence_guard_all_green: $review_rts_evidence_crate_batch_evidence_guard_all_green,
      evidence_crate_controls_playable_runtime: $review_rts_evidence_crate_batch_controls_runtime,
      playable_renderer_ownership_claimed: $review_rts_evidence_crate_batch_renderer_ownership_claimed,
      live_bevy_renderer_behavior_moved_to_rts_evidence: $review_rts_evidence_crate_batch_live_renderer_moved,
      external_action_performed: $review_rts_evidence_crate_batch_external_action_performed,
      history_rewrite_performed: $review_rts_evidence_crate_batch_history_rewrite_performed,
    ...
    review_evidence_exposure_batch: {
      doc_path: $review_evidence_exposure_batch_doc,
      artifact_path: "acceptance/S6_public_launch/latest/trillionnium-world-review-evidence-exposure-batch.json",
      status: $review_evidence_exposure_batch_status,
      batch_order: 3,
      sub_batch_order: 6,
      sub_batch_id: "review_evidence_exposure_boundary",
      reviewed_commit_count: $review_evidence_exposure_batch_reviewed_commit_count,
      unresolved_commit_review_count: $review_evidence_exposure_batch_unresolved_count,
      batch_3_reviewed_commit_count: $review_evidence_exposure_batch_batch3_reviewed_count,
      batch_3_remaining_commit_level_review_count: $review_evidence_exposure_batch_batch3_remaining_count,
      sub_batch_6_local_review_complete: $review_evidence_exposure_batch_local_review_complete,
      sub_batch_6_exit_rule_satisfied: $review_evidence_exposure_batch_exit_rule_satisfied,
      sub_batch_7_unblocked_for_local_review: $review_evidence_exposure_batch_next_unblocked,
      batch_3_exit_rule_satisfied: $review_evidence_exposure_batch_batch3_exit_rule_satisfied,
      batch_4_unblocked_for_local_review: $review_evidence_exposure_batch_batch4_unblocked,
      next_sub_batch_id: $review_evidence_exposure_batch_next_sub_batch_id,
      first_contact_runtime_review_gate: $review_evidence_exposure_batch_runtime_review_gate,
      classic_visual_flow_counts_exposed: $review_evidence_exposure_batch_visual_flow_counts_exposed,
      packet_assembly_review_exposed: $review_evidence_exposure_batch_packet_assembly_exposed,
      exposed_review_artifacts_local_only: $review_evidence_exposure_batch_local_only,
      playable_renderer_ownership_claimed: $review_evidence_exposure_batch_renderer_ownership_claimed,
      render_world_extraction_complete_claimed: $review_evidence_exposure_batch_render_world_claimed,
      gpu_upload_claimed: $review_evidence_exposure_batch_gpu_upload_claimed,
      external_action_performed: $review_evidence_exposure_batch_external_action_performed,
    ...
    review_generated_count_surface_batch: {
      doc_path: $review_generated_count_surface_batch_doc,
      artifact_path: "acceptance/S6_public_launch/latest/trillionnium-world-review-generated-count-surface-batch.json",
      status: $review_generated_count_surface_batch_status,
      batch_order: 4,
      bucket_id: "unclassified_generated_count_surface",
      reviewed_commit_count: $review_generated_count_surface_batch_reviewed_commit_count,
      unresolved_generated_count_surface_review_count: $review_generated_count_surface_batch_unresolved_count,
      count_contract_owner_assignment_complete: $review_generated_count_surface_batch_owner_assignment_complete,
      owning_checker_artifact_binding_complete: $review_generated_count_surface_batch_binding_complete,
      release_ci_count_guard_bound: $review_generated_count_surface_batch_release_ci_guard_bound,
      packet_semantic_count_guard_bound: $review_generated_count_surface_batch_packet_guard_bound,
      prior_batch_3_closed: $review_generated_count_surface_batch_prior_batch3_closed,
      batch_4_exit_rule_satisfied: $review_generated_count_surface_batch_exit_rule_satisfied,
      batch_5_unblocked_for_local_review: $review_generated_count_surface_batch_batch5_unblocked,
      next_batch_bucket_id: $review_generated_count_surface_batch_next_batch_bucket_id,
      public_launch_ready_claimed: $review_generated_count_surface_batch_public_launch_claimed,
      android_s5_real_device_claimed: $review_generated_count_surface_batch_android_s5_claimed,
      external_action_performed: $review_generated_count_surface_batch_external_action_performed,
    ...
    review_bot_executor_surface_batch: {
      doc_path: $review_bot_executor_surface_batch_doc,
      artifact_path: "acceptance/S6_public_launch/latest/trillionnium-world-review-bot-executor-surface-batch.json",
      status: $review_bot_executor_surface_batch_status,
      batch_order: 6,
      bucket_id: "unclassified_bot_executor_surface",
      reviewed_commit_count: $review_bot_executor_surface_batch_reviewed_commit_count,
      unresolved_bot_executor_surface_review_count: $review_bot_executor_surface_batch_unresolved_count,
      bot_executor_surface_route_complete: $review_bot_executor_surface_batch_route_complete,
      packet_semantic_fixture_owner_bound: $review_bot_executor_surface_batch_packet_fixture_bound,
      rts_runtime_data_boundary_preserved: $review_bot_executor_surface_batch_runtime_boundary_preserved,
      release_evidence_contract_bound: $review_bot_executor_surface_batch_release_evidence_bound,
      prior_batch_5_closed: $review_bot_executor_surface_batch_prior_batch5_closed,
      batch_6_exit_rule_satisfied: $review_bot_executor_surface_batch_exit_rule_satisfied,
      batch_7_unblocked_for_local_review: $review_bot_executor_surface_batch_batch7_unblocked,
      next_batch_bucket_id: $review_bot_executor_surface_batch_next_batch_bucket_id,
      bevy_integration_ownership_claimed: $review_bot_executor_surface_batch_bevy_integration_claimed,
      public_launch_ready_claimed: $review_bot_executor_surface_batch_public_launch_claimed,
      android_s5_real_device_claimed: $review_bot_executor_surface_batch_android_s5_claimed,
      external_action_performed: $review_bot_executor_surface_batch_external_action_performed,
      history_rewrite_performed: $review_bot_executor_surface_batch_history_rewrite_performed,
...
jq -e '
  ...
  and .reviewer_handoff_index.artifact_count == 46
  ...
  and .review_first_contact_rts_data_batch.status == "review_first_contact_rts_data_sub_batch_4_reviewed"
  and .review_first_contact_rts_data_batch.batch_order == 3
  and .review_first_contact_rts_data_batch.sub_batch_order == 4
  and .review_first_contact_rts_data_batch.sub_batch_id == "first_contact_rts_data_extraction"
  and .review_first_contact_rts_data_batch.reviewed_commit_count == 24
  and .review_first_contact_rts_data_batch.unresolved_commit_review_count == 0
  and .review_first_contact_rts_data_batch.batch_3_reviewed_commit_count == 171
  and .review_first_contact_rts_data_batch.batch_3_remaining_commit_level_review_count == 102
  and .review_first_contact_rts_data_batch.sub_batch_4_local_review_complete == true
  and .review_first_contact_rts_data_batch.sub_batch_4_exit_rule_satisfied == true
  and .review_first_contact_rts_data_batch.sub_batch_5_unblocked_for_local_review == true
  and .review_first_contact_rts_data_batch.batch_3_exit_rule_satisfied == false
  and .review_first_contact_rts_data_batch.batch_4_unblocked_for_local_review == false
  and .review_first_contact_rts_data_batch.next_sub_batch_id == "rts_evidence_crate_boundary"
  and .review_first_contact_rts_data_batch.basin_spec_green == true
  and .review_first_contact_rts_data_batch.rts_data_profiles_renderer_neutral == true
  and .review_first_contact_rts_data_batch.renderer_draw_math_moved_to_rts_data == false
  and .review_first_contact_rts_data_batch.live_bevy_renderer_behavior_moved_to_rts_data == false
  and .review_first_contact_rts_data_batch.external_action_performed == false
  and .review_first_contact_rts_data_batch.history_rewrite_performed == false
  and .review_rts_evidence_crate_batch.status == "review_rts_evidence_crate_sub_batch_5_reviewed"
  and .review_rts_evidence_crate_batch.batch_order == 3
  and .review_rts_evidence_crate_batch.sub_batch_order == 5
  and .review_rts_evidence_crate_batch.sub_batch_id == "rts_evidence_crate_boundary"
  and .review_rts_evidence_crate_batch.reviewed_commit_count == 20
  and .review_rts_evidence_crate_batch.unresolved_commit_review_count == 0
  and .review_rts_evidence_crate_batch.batch_3_reviewed_commit_count == 191
  and .review_rts_evidence_crate_batch.batch_3_remaining_commit_level_review_count == 82
  and .review_rts_evidence_crate_batch.sub_batch_5_local_review_complete == true
  and .review_rts_evidence_crate_batch.sub_batch_5_exit_rule_satisfied == true
  and .review_rts_evidence_crate_batch.sub_batch_6_unblocked_for_local_review == true
  and .review_rts_evidence_crate_batch.batch_3_exit_rule_satisfied == false
  and .review_rts_evidence_crate_batch.batch_4_unblocked_for_local_review == false
  and .review_rts_evidence_crate_batch.next_sub_batch_id == "review_evidence_exposure_boundary"
  and .review_rts_evidence_crate_batch.evidence_guard_all_green == true
  and .review_rts_evidence_crate_batch.evidence_crate_controls_playable_runtime == false
  and .review_rts_evidence_crate_batch.playable_renderer_ownership_claimed == false
  and .review_rts_evidence_crate_batch.live_bevy_renderer_behavior_moved_to_rts_evidence == false
  and .review_rts_evidence_crate_batch.external_action_performed == false
  and .review_rts_evidence_crate_batch.history_rewrite_performed == false
  and .review_evidence_exposure_batch.status == "review_evidence_exposure_sub_batch_6_reviewed"
  and .review_evidence_exposure_batch.batch_order == 3
  and .review_evidence_exposure_batch.sub_batch_order == 6
  and .review_evidence_exposure_batch.sub_batch_id == "review_evidence_exposure_boundary"
  and .review_evidence_exposure_batch.reviewed_commit_count == 12
  and .review_evidence_exposure_batch.unresolved_commit_review_count == 0
  and .review_evidence_exposure_batch.batch_3_reviewed_commit_count == 203
  and .review_evidence_exposure_batch.batch_3_remaining_commit_level_review_count == 70
  and .review_evidence_exposure_batch.sub_batch_6_local_review_complete == true
  and .review_evidence_exposure_batch.sub_batch_6_exit_rule_satisfied == true
  and .review_evidence_exposure_batch.sub_batch_7_unblocked_for_local_review == true
  and .review_evidence_exposure_batch.batch_3_exit_rule_satisfied == false
  and .review_evidence_exposure_batch.batch_4_unblocked_for_local_review == false
  and .review_evidence_exposure_batch.next_sub_batch_id == "bevy_runtime_renderer_boundary"
  and .review_evidence_exposure_batch.first_contact_runtime_review_gate == true
  and .review_evidence_exposure_batch.classic_visual_flow_counts_exposed == true
  and .review_evidence_exposure_batch.packet_assembly_review_exposed == true
  and .review_evidence_exposure_batch.exposed_review_artifacts_local_only == true
  and .review_evidence_exposure_batch.playable_renderer_ownership_claimed == false
  and .review_evidence_exposure_batch.render_world_extraction_complete_claimed == false
  ...
  and .review_generated_count_surface_batch.status == "review_generated_count_surface_batch_4_ready"
  and .review_generated_count_surface_batch.batch_order == 4
  and .review_generated_count_surface_batch.bucket_id == "unclassified_generated_count_surface"
  and .review_generated_count_surface_batch.reviewed_commit_count == 14
  and .review_generated_count_surface_batch.unresolved_generated_count_surface_review_count == 0
  and .review_generated_count_surface_batch.count_contract_owner_assignment_complete == true
  and .review_generated_count_surface_batch.owning_checker_artifact_binding_complete == true
  and .review_generated_count_surface_batch.release_ci_count_guard_bound == true
  and .review_generated_count_surface_batch.packet_semantic_count_guard_bound == true
  and .review_generated_count_surface_batch.prior_batch_3_closed == true
  and .review_generated_count_surface_batch.batch_4_exit_rule_satisfied == true
  and .review_generated_count_surface_batch.batch_5_unblocked_for_local_review == true
  and .review_generated_count_surface_batch.next_batch_bucket_id == "unclassified_docs_plan_truth_source"
  and .review_generated_count_surface_batch.public_launch_ready_claimed == false
  ...
  and .review_bot_executor_surface_batch.status == "review_bot_executor_surface_batch_6_ready"
  and .review_bot_executor_surface_batch.batch_order == 6
  and .review_bot_executor_surface_batch.bucket_id == "unclassified_bot_executor_surface"
  and .review_bot_executor_surface_batch.reviewed_commit_count == 10
  and .review_bot_executor_surface_batch.unresolved_bot_executor_surface_review_count == 0
  and .review_bot_executor_surface_batch.bot_executor_surface_route_complete == true
  and .review_bot_executor_surface_batch.packet_semantic_fixture_owner_bound == true
  and .review_bot_executor_surface_batch.rts_runtime_data_boundary_preserved == true
  and .review_bot_executor_surface_batch.release_evidence_contract_bound == true
  and .review_bot_executor_surface_batch.prior_batch_5_closed == true
  and .review_bot_executor_surface_batch.batch_6_exit_rule_satisfied == true
  and .review_bot_executor_surface_batch.batch_7_unblocked_for_local_review == true
  and .review_bot_executor_surface_batch.next_batch_bucket_id == "unclassified_classic_evidence_surface"
  and .review_bot_executor_surface_batch.bevy_integration_ownership_claimed == false
  and .review_bot_executor_surface_batch.public_launch_ready_claimed == false
  and .review_bot_executor_surface_batch.android_s5_real_device_claimed == false
  and .review_bot_executor_surface_batch.external_action_performed == false
  and .review_bot_executor_surface_batch.history_rewrite_performed == false
...

{
  ...
  printf -- '- bot/executor surface batch review: `%s`\n\n' "$REVIEW_BOT_EXECUTOR_SURFACE_BATCH_DOC_REL"
