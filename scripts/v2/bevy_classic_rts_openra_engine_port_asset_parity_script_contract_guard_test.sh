...
required_script_lines=(
  ...
  'source_headline_field_count'
  'asset_manifest_field_count'
  'pixel_parity_field_count'
  'pixel_parity_manifest_frame_id_count'
  'pixel_parity_sample_report_count'
  'artifact_path_count'
  'pixel_count_field_count'
  'gate_count'
  'passed_gate_count'
  'failed_gate_count'
...
required_readiness_lines=(
  ...
  'rts_openra_engine_port_asset_parity_source_contract_count'
  'rts_openra_engine_port_asset_parity_source_headline_field_count'
  'rts_openra_engine_port_asset_parity_asset_manifest_field_count'
  'rts_openra_engine_port_asset_parity_pixel_parity_field_count'
  'rts_openra_engine_port_asset_parity_manifest_frame_id_count'
  'rts_openra_engine_port_asset_parity_sample_report_count'
  'rts_openra_engine_port_asset_parity_artifact_path_count'
  'rts_openra_engine_port_asset_parity_pixel_count_field_count'
  'rts_openra_engine_port_asset_parity_gate_count'
  'rts_openra_engine_port_asset_parity_passed_gate_count'
  'rts_openra_engine_port_asset_parity_failed_gate_count'
