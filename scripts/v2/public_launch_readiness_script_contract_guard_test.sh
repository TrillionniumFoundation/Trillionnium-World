...
required_lines=(
  ...
  'green: (($blockers - $known_public_launch_blockers) | length == 0)'
  ...
  'unknown_blockers: ($blockers - $known_public_launch_blockers)'
  'unknown_blocker_count: (($blockers - $known_public_launch_blockers) | length)'
