...
grep -q 'desktop_real_machine_green' "$SCRIPT"
grep -q 'desktop_before_mobile_gate' "$SCRIPT"
grep -q 'desktop_product_visual_alignment_gate' "$SCRIPT"
grep -q 'mobile_evidence_priority' "$SCRIPT"
grep -q 'active_priority_blockers' "$SCRIPT"
