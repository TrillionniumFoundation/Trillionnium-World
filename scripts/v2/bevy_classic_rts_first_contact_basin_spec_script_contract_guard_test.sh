...
basin_lines=(
  ...
  'first_contact_runtime_core_visibility.runtime_core_inline_health_bar_actor_count == 5'
  'first_contact_runtime_core_visibility.runtime_core_suppressed_inline_health_bar_actor_count == 29'
  'first_contact_runtime_core_visibility.runtime_core_progress_bar_actor_count == 2'
  'first_contact_runtime_core_visibility.runtime_core_selection_ring_candidate_actor_count == 34'
  'first_contact_runtime_core_visibility.runtime_core_selection_ring_visible_actor_count == 0'
  'first_contact_runtime_core_visibility.runtime_core_suppressed_selection_ring_actor_count == 34'
  'first_contact_runtime_core_visibility.runtime_core_unit_role_accent_candidate_actor_count == 29'
  'first_contact_runtime_core_visibility.runtime_core_unit_role_accent_visible_actor_count == 0'
  'first_contact_runtime_core_visibility.runtime_core_suppressed_unit_role_accent_actor_count == 29'
