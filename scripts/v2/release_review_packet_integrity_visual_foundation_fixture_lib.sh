...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  cat >"$first_contact_basin_spec_filter" <<'JQ'
  {
    ...
    first_contact_silhouette_readability_guard: {
      ...
      preview_resource_sample_tiles: ["12,16", "21,16", "16,12", "16,21", "8,16", "25,16", "10,10", "23,23", "23,10", "10,23", "16,16"],
      preview_resource_roles: ["flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom", "flux_bloom"],
      preview_resource_signatures: ["resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues", "resource_bloom_micro_shadow_cues"],
      preview_resource_samples: [
        {tile: "12,16", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "21,16", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "16,12", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "16,21", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "8,16", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "25,16", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "10,10", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "23,23", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "23,10", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "10,23", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"},
        {tile: "16,16", role: "flux_bloom", signature: "resource_bloom_micro_shadow_cues"}
      ],
      preview_resource_bloom_count: 11,
      preview_resource_bloom_cues_per_cluster: 4,
      preview_resource_bloom_cue_width_px: 6,
      preview_resource_bloom_cue_height_px: 2,
      preview_resource_bloom_pixel_budget: 528,
      preview_resource_bloom_gate: true,
      ...
      player_screen_secondary_beacon_body_samples: [
        {tile: "16,24", role: "beacon", signature: "vertical_beacon_spire"},
        {tile: "9,16", role: "beacon", signature: "vertical_beacon_spire"},
        {tile: "24,16", role: "beacon", signature: "vertical_beacon_spire"}
      ],
    ...
    first_contact_motion_readability_guard: {
      ...
      command_feedback_motion_signatures: [
        ...
        "command_feedback_panel_backplate_suppressed",
        "command_feedback_progress_micro_pips",
        "command_feedback_progress_backplates_suppressed"
      ],
      feedback_panel_cue_count: 8,
      feedback_panel_cue_width_px: 6,
      feedback_panel_cue_height_px: 2,
      feedback_panel_cue_pixel_budget: 96,
      feedback_panel_backplate_width_px: 0,
      feedback_panel_backplate_height_px: 0,
      feedback_panel_backplate_pixel_budget: 0,
      feedback_panel_micro_cue_gate: true,
      feedback_panel_backplate_gate: true,
      ...
      feedback_progress_backplate_pixel_budget: 0,
      feedback_progress_micro_pip_gate: true,
      feedback_progress_backplate_gate: true,
    ...
    first_contact_selection_combat_focus_guard: {
      ...
      target_focus_tile: "16,9",
      blocked_focus_tile: "15,16",
      focus_signatures: ["selected_corner_brackets", "selected_role_badge_micro_pips", "compact_route_dashes", "route_ack_step_micro_dots", "route_ack_micro_dots", "route_clearance_corner_cues", "attack_target_lock_micro_corner_ticks", "compact_target_lock_cross", "target_ack_micro_tick", "blocked_warning_cross"],
      route_dash_count: 4,
      ...
      combat_target_cross_long_px: 6,
      combat_target_cross_thickness_px: 2,
      combat_target_bracket_tick_long_px: 6,
      combat_target_bracket_tick_thickness_px: 2,
    ...
    first_contact_target_callout_guard: {
      ...
      target_prefocus_corner_tick_long_px: 6,
      ...
      target_callout_signatures: ["compact_target_callout_plate", "target_subject_label", "target_health_micro_pips", "short_leader_ticks", "prefocus_target_corner_ticks", "prefocus_target_cross_thinned", "target_lock_preserved"],
    ...
    first_contact_marker_budget_guard: {
      ...
      player_screen_secondary_beacon_marker_gate: true,
