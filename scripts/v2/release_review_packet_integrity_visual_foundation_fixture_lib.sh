...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  jq -n '{
    ...
    first_contact_marker_budget_guard: {
      ...
      gallery_presentation_signatures: ["muted_gallery_slot_cues", "darkened_gallery_frames", "lower_lane_gallery_deemphasis", "lower_lane_micro_slot_cues", "lower_lane_dim_silhouettes", "lower_lane_shadow_suppressed", "lower_lane_ghost_anchors", "lower_lane_two_point_ghost_anchors", "compact_route_ack_ticks", "perimeter_gallery_lane_budget", "interactive_focus_kept_hot"],
