...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  jq -n '{
    ...
    first_contact_visual_hierarchy_guard: {
      ...
      hierarchy_signatures: ["route_corridor_deemphasis", "route_spine_shadow", "selected_halo_backplates", "attack_target_backplate", "blocked_warning_backplate", "perimeter_gallery_preserved"],
      corridor_deemphasis_pixel_budget: 546,
      route_spine_shadow_pixel_budget: 180,
      selected_halo_pixel_budget: 384,
      target_backplate_pixel_budget: 192,
      blocked_backplate_pixel_budget: 132,
    ...
    first_contact_central_clarity_guard: {
      ...
      focus_overlap_tiles: [],
      quiet_tile_pixel_budget: 1248,
      quiet_edge_pixel_budget: 234,
      clarity_signatures: ["central_negative_space_tiles", "focus_corridor_not_muted", "quiet_edge_separators", "selection_focus_still_last"],
    ...
    first_contact_terminal_legibility_guard: {
      ...
      target_edge_pixel_budget: 90,
      blocked_edge_pixel_budget: 144,
      terminal_signatures: ["target_terminal_quiet_band", "blocked_terminal_quiet_column", "route_terminal_focus_preserved", "focus_markers_still_last"],
    ...
    first_contact_selection_combat_focus_guard: {
      ...
      target_focus_tile: "16,9",
      blocked_focus_tile: "15,16",
      focus_signatures: ["selected_corner_brackets", "selected_role_badge_ticks", "compact_selected_role_badge_ticks", "wide_route_dashes", "route_ack_step_ticks", "compact_route_ack_ticks", "route_clearance_gutters", "attack_target_lock_brackets", "compact_target_lock_cross", "blocked_warning_cross"],
      route_dash_count: 4,
      ...
      selected_focus_pixel_budget: 328,
      route_dash_pixel_budget: 192,
      ...
      combat_target_ack_tick_width_px: 18,
      combat_target_ack_tick_height_px: 4,
    ...
    first_contact_target_callout_guard: {
      ...
      target_callout_clearance_pixel_budget: 2844,
      ...
      target_callout_signatures: ["target_callout_clearance_gutter", "target_subject_label", "target_health_strip", "short_leader_ticks", "prefocus_target_rings_capped", "prefocus_target_cross_thinned", "target_lock_preserved"],
    ...
    first_contact_marker_budget_guard: {
      ...
      route_focus_tiles: ["14,11", "15,11", "16,10", "16,9"],
      selected_role_badge_tick_pixel_budget: 72,
      interactive_focus_pixel_budget: 892,
      gallery_presentation_signatures: ["muted_gallery_slot_cues", "perimeter_gallery_edge_anchors", "perimeter_gallery_single_pixel_anchors", "darkened_gallery_frames", "lower_lane_gallery_deemphasis", "lower_lane_micro_slot_cues", "lower_lane_frame_suppressed", "lower_lane_anchor_only", "lower_lane_shadow_suppressed", "lower_lane_ghost_anchors", "lower_lane_single_point_ghost_anchors", "compact_route_ack_ticks", "perimeter_gallery_lane_budget", "interactive_focus_kept_hot", "non_focus_owner_identity_muted", "player_screen_primary_tactical_track_only", "player_screen_hover_route_path_suppressed"],
    ...
    first_contact_runtime_core_visibility: {
      ...
      runtime_core_visible_actor_count: 34,
      runtime_core_inline_health_bar_actor_count: 5,
      runtime_core_suppressed_inline_health_bar_actor_count: 29,
      runtime_core_progress_bar_actor_count: 2,
      runtime_core_selection_ring_candidate_actor_count: 34,
      runtime_core_selection_ring_visible_actor_count: 0,
      runtime_core_suppressed_selection_ring_actor_count: 34,
      runtime_core_unit_role_accent_candidate_actor_count: 29,
      runtime_core_unit_role_accent_visible_actor_count: 0,
      runtime_core_suppressed_unit_role_accent_actor_count: 29,
      runtime_core_hidden_fixture_actor_count: 49,
      runtime_core_hidden_control_fixture_actor_count: 48,
      runtime_core_visible_actor_ids: ["map.actor0", "map.actor15", "multi0.attackmove.warden", "multi0.capture.contested.warden", "multi0.command.core", "multi0.damaged.relay", "multi0.flux.relay", "multi0.focus.warden.a", "multi0.focus.warden.b", "multi0.guard.sentinel", "multi0.line.0", "multi0.obstruction.blocker", "multi0.obstruction.follower", "multi0.obstruction.leader", "multi0.patrol.warden", "multi0.priority.guard", "multi0.reservation.lead", "multi0.reservation.wing", "multi0.scout.intel", "multi0.scout.spotter", "multi0.stance.aggressive", "multi0.stance.guard", "multi0.stance.spotter", "multi0.stop.warden", "multi0.striker.0", "multi0.traffic.lead", "multi0.traffic.stuck.blocker", "multi0.traffic.stuck.runner", "multi0.traffic.yield", "multi0.veteran.warden", "multi0.warden.capture", "multi0.worker.0", "multi0.worker.1", "multi0.worker.repair"],
      runtime_core_inline_health_bar_actor_ids: ["multi0.damaged.relay", "multi0.line.0", "multi0.scout.intel", "multi0.veteran.warden", "multi0.warden.capture"],
      runtime_core_progress_bar_actor_ids: ["map.actor15", "multi0.worker.1"],
      runtime_core_selection_ring_candidate_actor_ids: ["map.actor0", "map.actor15", "multi0.attackmove.warden", "multi0.capture.contested.warden", "multi0.command.core", "multi0.damaged.relay", "multi0.flux.relay", "multi0.focus.warden.a", "multi0.focus.warden.b", "multi0.guard.sentinel", "multi0.line.0", "multi0.obstruction.blocker", "multi0.obstruction.follower", "multi0.obstruction.leader", "multi0.patrol.warden", "multi0.priority.guard", "multi0.reservation.lead", "multi0.reservation.wing", "multi0.scout.intel", "multi0.scout.spotter", "multi0.stance.aggressive", "multi0.stance.guard", "multi0.stance.spotter", "multi0.stop.warden", "multi0.striker.0", "multi0.traffic.lead", "multi0.traffic.stuck.blocker", "multi0.traffic.stuck.runner", "multi0.traffic.yield", "multi0.veteran.warden", "multi0.warden.capture", "multi0.worker.0", "multi0.worker.1", "multi0.worker.repair"],
      runtime_core_selection_ring_visible_actor_ids: [],
      runtime_core_unit_role_accent_candidate_actor_ids: ["multi0.attackmove.warden", "multi0.capture.contested.warden", "multi0.focus.warden.a", "multi0.focus.warden.b", "multi0.guard.sentinel", "multi0.line.0", "multi0.obstruction.blocker", "multi0.obstruction.follower", "multi0.obstruction.leader", "multi0.patrol.warden", "multi0.priority.guard", "multi0.reservation.lead", "multi0.reservation.wing", "multi0.scout.intel", "multi0.scout.spotter", "multi0.stance.aggressive", "multi0.stance.guard", "multi0.stance.spotter", "multi0.stop.warden", "multi0.striker.0", "multi0.traffic.lead", "multi0.traffic.stuck.blocker", "multi0.traffic.stuck.runner", "multi0.traffic.yield", "multi0.veteran.warden", "multi0.warden.capture", "multi0.worker.0", "multi0.worker.1", "multi0.worker.repair"],
      runtime_core_unit_role_accent_visible_actor_ids: [],
      runtime_core_hidden_fixture_actor_ids: ["multi0.append.runner", "multi0.append.seed", "multi0.append.wing", "multi0.assignment.runner", "multi0.assignment.wing", "multi0.chain.runner", "multi0.clear.seed", "multi0.clear.wing", "multi0.formation.blocked.lead", "multi0.formation.blocked.left", "multi0.formation.blocked.right", "multi0.formation.lead", "multi0.formation.left", "multi0.formation.prune.runner", "multi0.formation.right", "multi0.formation.slot.blocker", "multi0.formation.validation.runner", "multi0.group.validation.runner", "multi0.override.runner", "multi0.queue.prune.runner", "multi0.queue.reject.runner", "multi0.reassignment.runner", "multi0.reassignment.stale", "multi0.reassignment.wing", "multi0.rebuild.old.seed", "multi0.rebuild.old.wing", "multi0.rebuild.runner", "multi0.rebuild.wing", "multi0.recall.formation.old.seed", "multi0.recall.formation.old.wing", "multi0.recall.formation.runner", "multi0.recall.formation.wing", "multi0.recall.order.old.seed", "multi0.recall.order.old.wing", "multi0.recall.order.runner", "multi0.recall.order.wing", "multi0.recall.override.old.seed", "multi0.recall.override.old.wing", "multi0.recall.override.runner", "multi0.recall.override.wing", "multi0.recall.rebuild.old.seed", "multi0.recall.rebuild.old.wing", "multi0.recall.rebuild.runner", "multi0.recall.rebuild.wing", "multi0.remove.runner", "multi0.remove.seed", "multi0.remove.wing", "multi0.stance.holdfire", "multi0.stance.prune.runner"],
      ...
      runtime_core_hidden_fixture_tile_ids: ["1,27", "1,30", "11,31", "13,31", "17,25", "17,29", "17,30", "18,25", "18,29", "18,30", "18,31", "19,25", "19,29", "19,30", "2,27", "2,30", "2,31", "20,25", "20,30", "21,29", "22,30", "23,27", "24,27", "24,29", "25,27", "26,27", "26,29", "27,27", "28,25", "28,27", "28,29", "28,30", "29,25", "29,27", "3,29", "3,30", "3,31", "30,27", "30,29", "30,30", "31,27", "31,28", "31,29", "31,31", "32,29"],
