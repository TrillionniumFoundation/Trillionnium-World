...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  jq -n '{
    ...
    first_contact_visual_hierarchy_guard: {
      ...
      hierarchy_layer_draw_order: ["terrain", "actors", "model_identity", "silhouette_readability", "art_readability", "animation_readability", "atlas_readability", "unit_state", "combat_phase", "command_feedback", "runtime_core", "tactical_tracks", "opening_actions", "readability_overlays", "visual_hierarchy_deemphasis", "central_clarity_deemphasis", "selection_combat_focus"],
    ...
    first_contact_selection_combat_focus_guard: {
      ...
      target_focus_tile: "16,9",
      blocked_focus_tile: "15,16",
      focus_signatures: ["selected_corner_brackets", "selected_role_badge_ticks", "wide_route_dashes", "route_ack_step_ticks", "attack_target_lock_brackets", "blocked_warning_cross"],
      route_dash_count: 4,
    ...
    first_contact_marker_budget_guard: {
      ...
      gallery_presentation_signatures: ["muted_gallery_slot_cues", "darkened_gallery_frames", "perimeter_gallery_lane_budget", "interactive_focus_kept_hot"],
      marker_budget_layer_draw_order: ["atlas_readability", "atlas_gallery_muted", "visual_hierarchy_deemphasis", "central_clarity_deemphasis", "selection_combat_focus"],
