...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  jq -n '{
    ...
    first_contact_visual_hierarchy_guard: {
      ...
      hierarchy_signatures: ["route_corridor_deemphasis", "route_spine_micro_shadow_cues", "selected_halo_backplates", "attack_target_micro_backplate", "blocked_warning_micro_backplate", "perimeter_gallery_preserved"],
