...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  jq -n '{
    ...
    first_contact_selection_combat_focus_guard: {
      ...
      target_focus_tile: "16,9",
      blocked_focus_tile: "15,16",
      focus_signatures: ["selected_corner_brackets", "selected_role_badge_micro_pips", "wide_route_dashes", "route_ack_step_micro_dots", "route_ack_micro_dots", "route_clearance_corner_cues", "attack_target_lock_brackets", "compact_target_lock_cross", "blocked_warning_cross"],
      route_dash_count: 4,
    ...
    first_contact_marker_budget_guard: {
      ...
      route_focus_tiles: ["14,11", "15,11", "16,10", "16,9"],
      selected_role_badge_tick_pixel_budget: 16,
      interactive_focus_pixel_budget: 764,
      gallery_presentation_signatures: ["muted_gallery_slot_cues", "perimeter_gallery_edge_anchors", "perimeter_gallery_single_pixel_anchors", "darkened_gallery_frames", "lower_lane_gallery_deemphasis", "lower_lane_micro_slot_cues", "lower_lane_frame_suppressed", "lower_lane_anchor_only", "lower_lane_shadow_suppressed", "lower_lane_ghost_anchors", "lower_lane_single_point_ghost_anchors", "route_ack_micro_dots", "perimeter_gallery_lane_budget", "interactive_focus_kept_hot", "non_focus_owner_identity_muted", "player_screen_primary_tactical_track_only", "player_screen_hover_route_path_suppressed"],
