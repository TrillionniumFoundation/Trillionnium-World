...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  jq -n '{
    ...
    first_contact_atlas_readability_guard: {
      ...
      atlas_family_sample_tiles: ["14,11", "14,12", "15,11", "15,10", "15,12", "16,12", "17,12", "8,8", "9,9", "11,8", "22,25", "16,9", "16,10", "16,24"],
      ...
      atlas_family_samples: [
        {tile: "14,11", role: "worker_unit_family", frame_id: "actor_worker_idle", signature: "worker_idle_frame_family", scale: 1},
        {tile: "14,12", role: "worker_unit_family", frame_id: "actor_worker_carry", signature: "worker_carry_frame_family", scale: 1},
        {tile: "15,11", role: "scout_unit_family", frame_id: "actor_player_walk_east_1", signature: "scout_stride_east_frame_family", scale: 2},
        {tile: "15,10", role: "scout_unit_family", frame_id: "actor_player_walk_east_2", signature: "scout_stride_east_alt_frame_family", scale: 2},
        {tile: "15,12", role: "warden_unit_family", frame_id: "actor_guard_idle", signature: "warden_guard_idle_frame_family", scale: 1},
        {tile: "16,12", role: "warden_unit_family", frame_id: "actor_guard_attack", signature: "warden_guard_attack_frame_family", scale: 1},
        {tile: "17,12", role: "relay_unit_family", frame_id: "actor_mentor_talk", signature: "relay_operator_talk_frame_family", scale: 1},
        {tile: "8,8", role: "command_core_structure_family", frame_id: "model_town_hall", signature: "command_core_town_hall_frame_family", scale: 1},
        {tile: "9,9", role: "command_core_structure_family", frame_id: "model_training_hall", signature: "command_core_training_hall_frame_family", scale: 1},
        {tile: "11,8", role: "relay_structure_family", frame_id: "model_waygate", signature: "relay_waygate_frame_family", scale: 1},
        {tile: "22,25", role: "relay_structure_family", frame_id: "prop_banner", signature: "relay_banner_frame_family", scale: 1},
        {tile: "16,9", role: "beacon_objective_family", frame_id: "marker_objective", signature: "beacon_objective_frame_family", scale: 1},
        {tile: "16,10", role: "beacon_objective_family", frame_id: "rts_command_destination_marker", signature: "beacon_destination_marker_frame_family", scale: 1},
        {tile: "16,24", role: "beacon_objective_family", frame_id: "marker_interaction", signature: "beacon_interaction_frame_family", scale: 1}
      ],
