...
add_first_contact_basin_source_manifest_packet_fixtures() {
  ...
  cat >"$first_contact_basin_spec_filter" <<'JQ'
  {
    ...
    first_contact_selection_combat_focus_guard: {
      ...
      combat_target_cross_long_px: 10,
      combat_target_cross_thickness_px: 2,
      combat_target_bracket_tick_long_px: 10,
    ...
    first_contact_target_callout_guard: {
      ...
      target_callout_signatures: ["compact_target_callout_plate", "target_subject_label", "target_health_strip", "short_leader_ticks", "prefocus_target_corner_ticks", "prefocus_target_cross_thinned", "target_lock_preserved"],
