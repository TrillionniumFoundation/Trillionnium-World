...
jq -n '{
  ...
  headline: {
    ...
    rts_full_game_visual_ui_replication_pixel_count_field_count: 19,
    ...
    rts_full_game_visual_ui_replication_first_contact_lane_ground_pixel_count: 97722,
    rts_full_game_visual_ui_replication_first_contact_hot_lane_anchor_pixel_count: 571,
    rts_full_game_visual_ui_replication_first_contact_combat_flow_pixel_count: 224,
    rts_full_game_visual_ui_replication_first_contact_target_rim_pixel_count: 192,
