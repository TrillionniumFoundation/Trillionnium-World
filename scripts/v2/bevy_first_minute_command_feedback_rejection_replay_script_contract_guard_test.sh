...
required_script_lines=(
  ...
  '.command_queue_blocked_feedback_chip_count == 7'
  ...
  '.blocked_feedback_source_label_gate == true'
  '.rejection_recording_input_source_gate == true'
  'classic_rts_mouse_sidebar'
  'classic_rts_hotkey'
  '.blocked_feedback_player_label_gate == true'
  '.blocked_feedback_chip_pixel_count > 240'
  '.blocked_feedback_chip_visual_gate == true'
...
required_source_lines=(
  ...
  'classic_rts_queue_requires_affordability_check'
  'classic_rts_blocked_feedback_player_label'
  'classic_rts_input_source_player_label'
  'classic_rts_blocked_feedback_toast'
