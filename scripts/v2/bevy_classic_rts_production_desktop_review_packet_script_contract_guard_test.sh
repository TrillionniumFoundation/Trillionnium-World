...
required_script_lines=(
  ...
  'passed_gate_count'
  'failed_gate_count'
  'production_interaction_source_contract_count'
  'production_interaction_source_path_count'
  'production_interaction_runtime_screen_layout_count'
  'production_interaction_pixel_count_field_count'
  'production_interaction_surface_name_count'
  'production_interaction_replacement_slot_count'
  'production_interaction_source_surface_count'
  'production_interaction_gate_count'
  'production_interaction_passed_gate_count'
  'production_interaction_failed_gate_count'
  'desktop_screenshot_frame_count'
  'desktop_keyboard_event_count'
  'desktop_mouse_event_count'
  'desktop_mouse_slot_a_bytes'
  'production_review_summary_field_count'
  'desktop_review_summary_field_count'
  'artifact_label_count'
  'artifact_path_count'
  'manual_review_checklist_count'
  'manual_review_step_count'
  'run_command_count'
  'no_credit_boundary_count'
  'live_public_network_exposure_performed'
  'live_osm_ingestion_performed'
