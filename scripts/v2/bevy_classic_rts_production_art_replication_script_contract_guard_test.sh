...
required_script_lines=(
  ...
  'first_contact_production_pack_v4_feature_count == 6'
  'first_contact_production_pack_v5_feature_count == 6'
  ...
  'first_contact_production_art_pack_v4_pixel_counts.terrain_strata > 100'
  'first_contact_production_art_pack_v4_gate == true'
  'first_contact_production_art_pack_v5_pixel_counts.terrain_micro_detail > 100'
  'first_contact_production_art_pack_v5_gate == true'
...
required_source_lines=(
  ...
  'first_contact_production_art_pack_v5_gate'
