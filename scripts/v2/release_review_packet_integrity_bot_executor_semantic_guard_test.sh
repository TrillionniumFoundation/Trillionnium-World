...
jq -n '{
  ...
  headline: {
    ...
    rts_full_game_visual_ui_replication_pixel_count_field_count: 36,
    ...
    rts_full_game_visual_ui_replication_gate_count: 14,
    rts_full_game_visual_ui_replication_passed_gate_count: 14,
    ...
    rts_full_game_visual_ui_replication_player_first_tactical_preview_non_background: 736016,
    ...
    rts_full_game_visual_ui_replication_first_contact_lane_ground_pixel_count: 97443,
    rts_full_game_visual_ui_replication_first_contact_hot_lane_anchor_pixel_count: 571,
    rts_full_game_visual_ui_replication_first_contact_combat_flow_pixel_count: 216,
    rts_full_game_visual_ui_replication_first_contact_target_rim_pixel_count: 216,
    rts_full_game_visual_ui_replication_first_contact_occluding_panel_pixel_count: 0,
    rts_full_game_visual_ui_replication_first_contact_production_art_pack_gate: true,
    rts_full_game_visual_ui_replication_first_contact_production_terrain_material_pixel_count: 75293,
    ...
    rts_full_game_visual_ui_replication_first_contact_production_v3_gate: true,
    rts_full_game_visual_ui_replication_first_contact_production_terrain_cluster_pixel_count: 7629,
    rts_full_game_visual_ui_replication_first_contact_production_transition_corner_pixel_count: 7936,
    rts_full_game_visual_ui_replication_first_contact_production_unit_role_block_pixel_count: 355,
    rts_full_game_visual_ui_replication_first_contact_production_structure_roof_depth_pixel_count: 943,
    rts_full_game_visual_ui_replication_first_contact_production_action_priority_ribbon_pixel_count: 182,
    rts_full_game_visual_ui_replication_first_contact_production_hud_command_plate_pixel_count: 31230,
    rts_full_game_visual_ui_replication_first_contact_production_v4_gate: true,
    rts_full_game_visual_ui_replication_first_contact_production_v5_gate: true,
    rts_full_game_visual_ui_replication_first_contact_production_terrain_strata_pixel_count: 18821,
    rts_full_game_visual_ui_replication_first_contact_production_edge_occlusion_pixel_count: 9059,
    rts_full_game_visual_ui_replication_first_contact_production_unit_readability_crest_pixel_count: 216,
    rts_full_game_visual_ui_replication_first_contact_production_structure_volume_shadow_pixel_count: 523,
    rts_full_game_visual_ui_replication_first_contact_production_action_intent_arrow_pixel_count: 170,
    rts_full_game_visual_ui_replication_first_contact_production_hud_focus_strip_pixel_count: 2976,
    rts_full_game_visual_ui_replication_first_contact_production_terrain_micro_detail_pixel_count: 8274,
    rts_full_game_visual_ui_replication_first_contact_production_edge_bevel_pixel_count: 6260,
    rts_full_game_visual_ui_replication_first_contact_production_unit_stance_shadow_pixel_count: 280,
    rts_full_game_visual_ui_replication_first_contact_production_structure_light_rim_pixel_count: 329,
    rts_full_game_visual_ui_replication_first_contact_production_action_target_chevron_pixel_count: 393,
    rts_full_game_visual_ui_replication_first_contact_production_hud_command_highlight_pixel_count: 2628,
...
if ! jq -e '
  ...
  and .green == false
  and (.failures | length) == 12
  and ([.failures[].name] | index("bot_planner_action_executor_semantics"))
  and ([.failures[].name] | index("bot_planner_action_executor_count_semantics"))
  ...
  and ([.failures[].name] | index("bot_planner_executor_replay_determinism_count_semantics"))
  ...
  and ([.failures[].name] | index("multi_match_bot_executor_evaluation_count_semantics"))
