...
REVIEW_SLICE_MANIFEST_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_slice_manifest.sh"
REVIEW_TRIAGE_QUEUE_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_triage_queue.sh"
REVIEW_PRIMARY_OWNER_PLAN_SCRIPT="$ROOT/scripts/check_trillionnium_world_review_primary_owner_plan.sh"
REVIEW_RELEASE_OWNER_QUEUE_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_release_owner_queue.sh"
REVIEW_RUNTIME_OWNER_QUEUE_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_runtime_owner_queue.sh"
REVIEW_RESIDUAL_QUEUE_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_residual_queue.sh"
...
REVIEW_RUNTIME_CORE_SEMANTICS_BATCH_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_runtime_core_semantics_batch.sh"
...
REVIEW_RTS_EVIDENCE_CRATE_BATCH_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_rts_evidence_crate_batch.sh"
REVIEW_EVIDENCE_EXPOSURE_BATCH_SCRIPT="$ROOT/scripts/check_trillionnium_world_review_evidence_exposure_batch.sh"
REVIEW_BEVY_RUNTIME_RENDERER_BATCH_SCRIPT="$ROOT/scripts/archive/world-bevy/check_trillionnium_world_review_bevy_runtime_renderer_batch.sh"
...
EVIDENCE_VOLUME_DOC="$ROOT/docs/archive/world-review-2026-07/trillionnium-world-evidence-volume-curation-2026-07-07.md"
REVIEWER_HANDOFF_DOC="$ROOT/docs/archive/world-bevy/development/trillionnium-world-reviewer-handoff-index-2026-07-07.md"
REVIEW_SLICE_DOC="$ROOT/docs/archive/world-review-2026-07/trillionnium-world-review-slice-strategy-2026-07-07.md"
...
BLOCKER_LEDGER_DOC="$ROOT/docs/archive/world-review-2026-07/trillionnium-world-public-launch-blocker-execution-ledger-2026-07-07.md"
...
required_script_lines=(
  ...
  'unresolved_generated_count_surface_review_count'
  'count_contract_owner_assignment_complete'
  'owning_checker_artifact_binding_complete'
  ...
  '.review_runtime_core_semantics_batch.reviewed_commit_count == 55'
  '.review_runtime_core_semantics_batch.unresolved_commit_review_count == 0'
  '.review_runtime_core_semantics_batch.systemic_runtime_core_boundary_followup_count == 1'
  '.review_runtime_core_semantics_batch.sub_batch_1_exit_rule_satisfied == false'
  ...
  '.review_generated_count_surface_batch.reviewed_commit_count == 14'
  '.review_generated_count_surface_batch.unresolved_generated_count_surface_review_count == 0'
  '.review_generated_count_surface_batch.count_contract_owner_assignment_complete == true'
  '.review_generated_count_surface_batch.owning_checker_artifact_binding_complete == true'
  '.review_generated_count_surface_batch.batch_4_exit_rule_satisfied == true'
...
required_review_runtime_core_semantics_batch_lines=(
  'Status: local review runtime-core semantics sub-batch 1.'
  'runtime_core_semantics'
  'Reviewed commit count: `55`'
  'Per-commit unresolved count: `0`'
  'systemic runtime-core source boundary follow-up'
  'sub_batch_1_exit_rule_satisfied=false'
  'batch_3_exit_rule_satisfied=false'
  'batch_4_unblocked_for_local_review=false'
)

required_review_runtime_core_semantics_batch_script_lines=(
  'trillionnium_world_review_runtime_core_semantics_batch_v1'
  'trillionnium-world-review-runtime-core-semantics-batch.json'
  'TRNM_WORLD_REVIEW_RUNTIME_CORE_SEMANTICS_BATCH_REFRESH_INPUTS'
  'review_runtime_core_semantics_sub_batch_1_reviewed_with_boundary_followup'
  'runtime_core_semantics'
  'reviewed_commit_count == 55'
...
required_review_generated_count_surface_batch_lines=(
  'Status: local review generated count surface batch 4.'
  'unclassified_generated_count_surface'
  'Reviewed commit count: `14`'
  'Per-count unresolved owner assignment count: `0`'
  'Generated count surfaces must be assigned to the checker and artifact'
  ...
  'next_batch_bucket_id=unclassified_docs_plan_truth_source'
)

required_review_generated_count_surface_batch_script_lines=(
  'trillionnium_world_review_generated_count_surface_batch_v1'
  'trillionnium-world-review-generated-count-surface-batch.json'
  'TRNM_WORLD_REVIEW_GENERATED_COUNT_SURFACE_BATCH_REFRESH_INPUTS'
  'review_generated_count_surface_batch_4_ready'
  'unclassified_generated_count_surface'
...
for line in "${required_review_runtime_core_semantics_batch_lines[@]}"; do
  if ! grep -Fq -- "$line" "$REVIEW_RUNTIME_CORE_SEMANTICS_BATCH_DOC"; then
    echo "[FAIL] review runtime-core semantics batch missing contract line: $line" >&2
    exit 1
  fi
done
...
for line in "${required_review_generated_count_surface_batch_lines[@]}"; do
  if ! grep -Fq -- "$line" "$REVIEW_GENERATED_COUNT_SURFACE_BATCH_DOC"; then
    echo "[FAIL] review generated count surface batch missing contract line: $line" >&2
    exit 1
  fi
done
