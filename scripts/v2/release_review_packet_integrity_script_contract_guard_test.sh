...
required_lines=(
  ...
  'status_match'
  'length == 115'
  'expected one hundred fifteen artifacts including live-window mouse hit-test sequence, classic playtest launcher, playtest handoff readiness/packet, full screen/UI replication, shell/meta UI replication, match setup UI replication, campaign outcome UI readiness, campaign UI continuity JSON/PPM, in-match HUD/state replication, session state continuity, combat readability/pressure readiness, camera/minimap sync JSON/PPM'
  ...
  'host_side_bevy_runtime_replay_not_android_real_device'
	  'packet_artifact_paths_must_exist_and_recorded_sha256_bytes_contract_status_must_match_current_files_including_checkpoint_manifest_packet_semantic_negative_fixture_classic_rts_control_loop_semantic_negative_fixture_classic_rts_selection_minimap_semantic_negative_fixture_classic_rts_build_lifecycle_semantic_negative_fixture_classic_rts_tech_tree_semantic_negative_fixture_classic_rts_projectile_ability_semantic_negative_fixture_bot_executor_source_chain_semantic_negative_fixture_bot_executor_failure_recovery_matrix_semantic_negative_fixture_bot_gap_foundation_micro_intel_semantic_negative_fixture_cex_adapter_local_bevy_playability_evidence_cex_adapter_readiness_semantics_keyboard_replay_semantics_classic_animation_preview_semantics_classic_animation_preview_ppm_semantics_classic_animation_selector_semantics_classic_player_motion_probe_semantics_classic_player_motion_probe_ppm_semantics_action_coach_semantics_player_hud_debug_layer_semantics_player_ui_rescue_semantics_live_window_screenshot_sequence_semantics_live_window_mouse_hit_test_sequence_semantics_sprite_texture_sampling_semantics_live_window_sampled_texture_correlation_semantics_render_asset_eligibility_semantics_public_launch_blocker_consistency_semantics_release_signoff_summary_semantics_release_review_quickcheck_semantics_release_review_status_semantics_release_review_convergence_semantics_map_modeling_gate_semantics_classic_asset_pack_semantics_classic_manifest_lint_semantics_classic_input_frame_budget_semantics_classic_render_budget_semantics_classic_isometric_modeling_semantics_classic_isometric_modeling_ppm_semantics_classic_scene_preview_semantics_classic_scene_preview_ppm_semantics_classic_model_catalog_semantics_classic_model_catalog_ppm_semantics_classic_renderer_probe_semantics_classic_renderer_probe_ppm_semantics_classic_playtest_runner_status_semantics_classic_playtest_launcher_semantics_classic_playtest_handoff_readiness_semantics_classic_playtest_handoff_packet_semantics_classic_playtest_readiness_semantics_full_screen_ui_replication_semantics_shell_meta_ui_replication_semantics_match_setup_ui_replication_semantics_campaign_outcome_ui_readiness_semantics_campaign_ui_continuity_semantics_campaign_ui_continuity_ppm_semantics_in_match_hud_state_replication_semantics_session_state_continuity_semantics_combat_readability_pressure_readiness_semantics_classic_rts_camera_minimap_sync_semantics_classic_rts_camera_minimap_sync_ppm_semantics_classic_rts_control_loop_semantics_classic_rts_selection_minimap_semantics_classic_rts_build_lifecycle_semantics_classic_rts_tech_tree_semantics_classic_rts_projectile_ability_semantics_first_minute_command_feedback_replay_semantics_first_minute_command_feedback_rejection_replay_semantics_bot_executor_source_chain_semantics_bot_executor_failure_recovery_matrix_semantics_and_bot_gap_foundation_micro_intel_semantics'
)
