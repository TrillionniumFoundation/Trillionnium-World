...
required_lines=(
  ...
  'status_match'
  'length == 105'
  'expected one hundred five artifacts including full screen/UI replication, shell/meta UI replication, match setup UI replication, campaign outcome UI readiness, in-match HUD/state replication'
