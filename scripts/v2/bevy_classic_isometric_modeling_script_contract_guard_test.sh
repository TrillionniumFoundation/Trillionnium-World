...
required_source_lines=(
  ...
  'classic_scene_rts_doodad_entities'
  ...
  'rts_doodad_entity_count'
  'doodad_detail_pixel_count'
  'doodad_stone_pixel_count'
  'doodad_wood_pixel_count'
  'doodad_fire_pixel_count'
  'doodad_crystal_pixel_count'
