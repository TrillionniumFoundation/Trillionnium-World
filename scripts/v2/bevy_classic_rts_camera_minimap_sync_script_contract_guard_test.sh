...
required_script_lines=(
  ...
  'gate_count == ([.viewport_visual_gate, .fog_visual_gate, .reveal_visual_gate, .selection_visual_gate, .route_visual_gate, .stage_gate, .viewport_sync_gate, .fog_reveal_gate, .large_map_minimap_gate, .selection_follow_gate, .control_group_sync_gate, .route_projection_gate, .zoom_rect_sync_gate, .minimap_runtime_gate, .scene_renderer_gate, .original_art_policy_gate] | length)'
  'failed_gate_count == 0'
