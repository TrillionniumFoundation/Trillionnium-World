...
required_script_lines=(
  ...
  'first_contact_pack_atlas_slot_count == 29'
  'first_contact_pack_v2_atlas_slot_count == 5'
  'first_contact_pack_v3_atlas_slot_count == 6'
  'first_contact_pack_v4_atlas_slot_count == 6'
  'first_contact_pack_v5_atlas_slot_count == 6'
  'first_contact_pack_atlas_slot_pixel_count > 12000'
...
required_source_lines=(
  ...
  'first_contact_pack_v5_atlas_slot_count'
