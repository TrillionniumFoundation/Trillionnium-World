...
for required in trnm-economy-protocol trnm-rpg-core trnm-campaign-core trnm-rts-protocol trnm-rts-sim trnm-first-contact; do
...
echo "TRNM game product boundary: green (6 game / 12 platform / legacy working tree absent)"
