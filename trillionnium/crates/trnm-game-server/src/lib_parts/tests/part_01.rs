...
mod tests {
    ...
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/lib_parts/tests/game_server_tests_01.rs"));
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/lib_parts/tests/game_server_tests_02.rs"));
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/lib_parts/tests/game_server_tests_03.rs"));
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/lib_parts/tests/game_server_tests_04.rs"));
}
