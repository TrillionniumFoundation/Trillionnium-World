...
use crate::{
    ...
    CLASSIC_FIRST_CONTACT_TARGET_PREFLIGHT_CORNER_TICK_LONG_PX,
...
fn focus_geometry_snapshot() -> trnm_rts_evidence::RtsFirstContactFocusReadabilityGeometrySnapshot {
    trnm_rts_evidence::RtsFirstContactFocusReadabilityGeometrySnapshot {
        ...
        target_lock_bracket_tick_long_px: CLASSIC_FIRST_CONTACT_TARGET_LOCK_BRACKET_TICK_LONG_PX,
        target_lock_bracket_tick_thickness_px:
            CLASSIC_FIRST_CONTACT_TARGET_LOCK_BRACKET_TICK_THICKNESS_PX,
        ...
        target_callout_health_pip_count: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_HEALTH_PIP_COUNT,
        target_callout_health_pip_width_px: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_HEALTH_PIP_W_PX,
        target_callout_health_pip_height_px: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_HEALTH_PIP_H_PX,
        target_callout_health_pip_gap_px: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_HEALTH_PIP_GAP_PX,
        ...
        target_callout_leader_clearance_height_px:
            CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_LEADER_CLEARANCE_H_PX,
        target_callout_edge_tick_count: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_EDGE_TICK_COUNT,
        target_callout_edge_tick_width_px: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_EDGE_TICK_W_PX,
        target_callout_edge_tick_height_px: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_EDGE_TICK_H_PX,
        target_callout_leader_tick_width_px: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_LEADER_TICK_W_PX,
        target_callout_leader_tick_height_px: CLASSIC_FIRST_CONTACT_TARGET_CALLOUT_LEADER_TICK_H_PX,
        target_preflight_ring_count: CLASSIC_FIRST_CONTACT_TARGET_PREFLIGHT_RING_COUNT as usize,
        target_preflight_ring_thickness_px:
            CLASSIC_FIRST_CONTACT_TARGET_PREFLIGHT_RING_THICKNESS_PX,
        target_preflight_corner_tick_long_px:
            CLASSIC_FIRST_CONTACT_TARGET_PREFLIGHT_CORNER_TICK_LONG_PX,
