...
pub(super) struct VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentRequest {
    method: HttpMethod,
    url: String,
...
#[allow(dead_code)]
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentResponse {
    status_code: u16,
    headers: BTreeMap<String, String>,
    frames: Vec<Vec<u8>>,
    window_start_sequence: u64,
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentPlanner:
    Send + Sync
{
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentExchange:
    Send + Sync
{
...
#[allow(dead_code)]
pub(super) struct DirectVerifierHttpClientSessionProtocolChunkTerminationTokenFragmentPlanner;

impl VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentPlanner
    for DirectVerifierHttpClientSessionProtocolChunkTerminationTokenFragmentPlanner
{
    fn plan_termination_token_fragment(
        &self,
        token_request: &VerifierHttpClientSessionProtocolChunkTerminationTokenRequest,
