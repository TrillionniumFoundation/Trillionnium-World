...
pub(super) struct VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentSliceRequest {
    method: HttpMethod,
    url: String,
...
pub(super) struct VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentSliceResponse {
    status_code: u16,
    headers: BTreeMap<String, String>,
    frames: Vec<Vec<u8>>,
    window_start_sequence: u64,
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentSlicePlanner: Send + Sync {
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentSliceExchange: Send + Sync {
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkVerdictProjectionNormalizationAdapter: Send + Sync {
...
#[allow(dead_code)]
pub(super) struct DirectVerifierHttpClientSessionProtocolChunkTerminationTokenFragmentSlicePlanner;

impl VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentSlicePlanner
    for DirectVerifierHttpClientSessionProtocolChunkTerminationTokenFragmentSlicePlanner
{
    fn plan_termination_token_fragment_slice(
        &self,
        fragment_request: &VerifierHttpClientSessionProtocolChunkTerminationTokenFragmentRequest,
