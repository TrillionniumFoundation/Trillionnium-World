...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkVerdictProjectionResolver:
    Send + Sync
{
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkNormalizedVerdictProjection:
    Send + Sync
{
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkVerdictProjectionNormalizer:
    Send + Sync
{
...
#[allow(dead_code)]
pub(super) trait VerifierHttpClientSessionProtocolChunkVerdictProjectionResolutionAdapter:
    Send + Sync
{
